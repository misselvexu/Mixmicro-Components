 ...
 */
package xyz.vopen.mixmicro.components.boot.monitor;
 ...
 * @since 2.1.0
 */
public class DefaultMonitorEnvironmentPostProcessor
    implements EnvironmentPostProcessor, Ordered {

  /**
   * The name of MultiDataSource default {@link PropertySource}
   */
  public static final String PROPERTY_SOURCE_NAME = "monitor-default";
   ...
   */
  public static final String RESOURCE_LOCATION_PATTERN = CLASSPATH_ALL_URL_PREFIX + "META-INF/monitor-default.properties";
