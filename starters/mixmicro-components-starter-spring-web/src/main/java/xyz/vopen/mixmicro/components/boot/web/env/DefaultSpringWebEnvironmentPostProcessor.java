 ...
 */
package xyz.vopen.mixmicro.components.boot.web.env;
 ...
 * @since 2.1.0
 */
public class DefaultSpringWebEnvironmentPostProcessor
    implements EnvironmentPostProcessor, Ordered {

  /**
   * The name of MultiDataSource default {@link PropertySource}
   */
  public static final String PROPERTY_SOURCE_NAME = "default-mixmicro-spring-web";
   ...
   */
  public static final String RESOURCE_LOCATION_PATTERN = CLASSPATH_ALL_URL_PREFIX + "META-INF/default-spring-web.properties";
