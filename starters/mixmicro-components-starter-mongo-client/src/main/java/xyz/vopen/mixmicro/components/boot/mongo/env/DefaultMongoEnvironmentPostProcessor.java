 ...
 */
package xyz.vopen.mixmicro.components.boot.mongo.env;
 ...
 * @since 2.1.0
 */
public class DefaultMongoEnvironmentPostProcessor
    implements EnvironmentPostProcessor, Ordered {

  /**
   * The name of MultiDataSource default {@link PropertySource}
   */
  public static final String PROPERTY_SOURCE_NAME = "mongo-client-default";
   ...
   */
  public static final String RESOURCE_LOCATION_PATTERN = CLASSPATH_ALL_URL_PREFIX + "META-INF/mongo-client-default.properties";
