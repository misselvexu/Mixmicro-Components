...
/**
 * {@link GracefulShutdownTomcatConnectorCustomizer}
 *
...
public class GracefulShutdownTomcatConnectorCustomizer implements TomcatConnectorCustomizer {
  private static final Logger LOG =
      LoggerFactory.getLogger(GracefulShutdownTomcatConnectorCustomizer.class);
  ...
  public GracefulShutdownTomcatConnectorCustomizer(
  ...
  private void awaitTermination(ThreadPoolExecutor executor) throws InterruptedException {
    for (long remaining = props.getTimeout().getSeconds();
        remaining > 0;
