...
import static xyz.vopen.mixmicro.components.boot.errors.Argument.arg;
...
import static xyz.vopen.mixmicro.components.boot.errors.handlers.ServletWebErrorHandler.METHOD_NOT_ALLOWED;
import static xyz.vopen.mixmicro.components.boot.errors.handlers.ServletWebErrorHandler.NOT_ACCEPTABLE;
...
public class ResponseStatusWebErrorHandler implements WebErrorHandler {
    ...
    public HandledException handle(Throwable exception) {
        ...
        if (exception instanceof ServerWebInputException) {
            ...
            return new HandledException(ServletWebErrorHandler.INVALID_OR_MISSING_BODY, BAD_REQUEST, null);
        }
        ...
        if (exception instanceof ResponseStatusException) {
            ...
            return new HandledException(LastResortWebErrorHandler.UNKNOWN_ERROR_CODE, status, null);
        }

        return new HandledException(LastResortWebErrorHandler.UNKNOWN_ERROR_CODE, INTERNAL_SERVER_ERROR, null);
    }
