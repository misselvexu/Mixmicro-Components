...
import xyz.vopen.mixmicro.components.boot.errors.fingerprint.UuidFingerprintProvider;
import xyz.vopen.mixmicro.components.boot.errors.handlers.LastResortWebErrorHandler;
import xyz.vopen.mixmicro.components.boot.errors.message.TemplateAwareMessageSource;
...
public class WebErrorHandlers {
    ...
    public HttpError handle(@Nullable Throwable originalException, @Nullable Object httpRequest, @Nullable Locale locale) {
        ...
        List<HttpError.CodedMessage> codeWithMessages = translateErrors(handled, locale);
