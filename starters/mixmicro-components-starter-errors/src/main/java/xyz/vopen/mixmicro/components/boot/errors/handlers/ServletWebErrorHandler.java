    ...
    public HandledException handle(Throwable exception) {
        ...
        if (exception instanceof HttpMediaTypeNotAcceptableException) {
            ...
            Map<String, List<Argument>> args = types.isEmpty() ?
                emptyMap() : singletonMap(NOT_ACCEPTABLE, singletonList(Argument.arg("types", types)));
        ...
        if (exception instanceof HttpMediaTypeNotSupportedException) {
            ...
            if (contentType != null) arguments = singletonList(Argument.arg("type", contentType.toString()));
        ...
        if (exception instanceof HttpRequestMethodNotSupportedException) {
            ...
            return new HandledException(METHOD_NOT_ALLOWED, HttpStatus.METHOD_NOT_ALLOWED,
                singletonMap(METHOD_NOT_ALLOWED, singletonList(Argument.arg("method", method)))
            );
        }
        ...
        if (exception instanceof MissingServletRequestParameterException) {
            ...
            return new HandledException(MISSING_PARAMETER, HttpStatus.BAD_REQUEST,
                singletonMap(MISSING_PARAMETER, asList(Argument.arg("name", name), Argument.arg("expected", type)))
            );
        }
        ...
        if (exception instanceof MissingServletRequestPartException) {
            ...
            return new HandledException(MISSING_PART, HttpStatus.BAD_REQUEST,
                singletonMap(MISSING_PART, singletonList(Argument.arg("name", name)))
            );
        }
        ...
        if (exception instanceof NoHandlerFoundException) {
            ...
            return new HandledException(NO_HANDLER, HttpStatus.NOT_FOUND,
                singletonMap(NO_HANDLER, singletonList(Argument.arg("path", url)))
            );
        }
