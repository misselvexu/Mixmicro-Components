...
public class MissingRequestParametersWebErrorHandler implements WebErrorHandler {
    ...
    public HandledException handle(Throwable exception) {
        ...
        if (exception instanceof MissingRequestHeaderException) {
            ...
            arguments.add(Argument.arg("expected", getType(headerException.getParameter())));
            ...
            arguments.add(Argument.arg("expected", getType(cookieException.getParameter())));
            ...
            arguments.add(Argument.arg("expected", getType(variableException.getParameter())));
