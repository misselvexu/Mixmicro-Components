...
import static xyz.vopen.mixmicro.components.boot.errors.handlers.TypeMismatchWebErrorHandler.TYPE_MISMATCH;
    ...
    private Object[] paramsForHandle() {
        return p(
            p(
                ...
                asList(Argument.arg("property", "username"), Argument.arg("invalid", "ali"), Argument.arg("expected", "String"))
            ),
            p(
                mismatch("username", "ali", null),
                asList(Argument.arg("property", "username"), Argument.arg("invalid", "ali"))
            )
        );
    }
