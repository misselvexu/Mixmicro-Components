package xyz.vopen.mixmicro.components.boot.errors.servlet;
...
import xyz.vopen.mixmicro.components.boot.errors.WebErrorHandlerPostProcessor;
import xyz.vopen.mixmicro.components.boot.errors.handlers.LastResortWebErrorHandler;
import xyz.vopen.mixmicro.components.boot.errors.handlers.MultipartWebErrorHandler;
...
import static xyz.vopen.mixmicro.components.boot.errors.handlers.ServletWebErrorHandler.*;
...
public class ServletIT {
    ...
    private Object[] provideInvalidBody() {
        return p(
            ...
            p(ServletController.Dto.dto(null, 10, "code"), null, cm("text.required", "The text is required")),
            p(ServletController.Dto.dto("", 10, "code"), null, cm("text.required", "The text is required")),
            p(ServletController.Dto.dto("", 10, "code"), new Locale("fa", "IR"), cm("text.required", "متن اجباری است")),
            p(ServletController.Dto.dto("text", -1, "code"), null, cm("number.min", "The min is 0")),
            p(ServletController.Dto.dto("text", 0), null, cm("range.limit", "Between 1 and 2")),
            p(
                ServletController.Dto.dto("", -1),
                null,
    ...
    private Object[] provideDefaultInvalidBody() {
        return p(
            p(new ServletController.DefaultDto().setActive(false), cm("isActive.shouldBeTrue", null)),
            p(new ServletController.DefaultDto().setFailed(true), cm("isFailed.shouldBeFalse", null)),
            p(new ServletController.DefaultDto().setDecimalMax(BigDecimal.valueOf(14)), cm("decimalMax.exceedsMax", null)),
            p(new ServletController.DefaultDto().setDecimalMin(BigDecimal.ONE), cm("decimalMin.lessThanMin", null)),
            p(new ServletController.DefaultDto().setUserEmail("email"), cm("userEmail.invalidEmail", null)),
            p(new ServletController.DefaultDto().setWrapper(new ServletController.Wrapper().setName("")), cm("wrapper.name.shouldNotBeBlank", null))
        );
    }
