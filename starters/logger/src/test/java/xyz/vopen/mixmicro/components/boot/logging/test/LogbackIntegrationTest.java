...
public class LogbackIntegrationTest extends BaseLogIntegrationTest {
  ...
  public void testDefaultLevel() throws IOException {
    ...
    FileUtils.write(
        logFile, StringUtil.EMPTY_STRING, environment.getProperty(Constants.LOG_ENCODING_PROP_KEY));
    logger.info("info level");
    logger.debug("debug level");
    List<String> contents =
        FileUtils.readLines(logFile, environment.getProperty(Constants.LOG_ENCODING_PROP_KEY));
  ...
  public void testWildLogLevel() throws IOException {
    ...
    LogEnvUtils.processGlobalSystemLogProperties().remove(Constants.LOG_LEVEL_PREFIX + "test.*");
  }
  ...
  public void testSpecifyLogLevel() throws IOException {
    ...
    LogEnvUtils.processGlobalSystemLogProperties()
        .remove(Constants.LOG_LEVEL_PREFIX + "test.space");
  }
  ...
  public void testLogConfig() throws IOException {
    ...
    LogEnvUtils.processGlobalSystemLogProperties().remove(Constants.LOG_CONFIG_PREFIX + TEST_SPACE);
  }

  /** test mixmicro.log.internal.level config */
  @Test
  public void testInternalLogLevel() {
    ReportUtil.reportDebug("debug");
    Assert.assertFalse(outContent.toString().contains("debug"));
    System.setProperty(Constants.MIXMICRO_LOG_INTERNAL_LEVEL, "debug");
    ReportUtil.reportDebug("debug");
    Assert.assertTrue(outContent.toString().contains("debug"));
  }

  /** test mixmicro.log.{space id}.console config */
  @Test
  public void testSpaceConsoleConfig() {
    Map<String, Object> properties = new HashMap<String, Object>();
    properties.put(
        String.format(Constants.MIXMICRO_SINGLE_LOG_CONSOLE_SWITCH, TEST_SPACE), "true");
    SpringApplication springApplication = new SpringApplication(EmptyConfig.class);
    springApplication.setDefaultProperties(properties);
    ...
    LogEnvUtils.processGlobalSystemLogProperties()
        .remove(String.format(Constants.MIXMICRO_SINGLE_LOG_CONSOLE_SWITCH, TEST_SPACE));
  }

  /** test mixmicro.log.{space id}.console.level config */
  @Test
  public void testSpaceConsoleLevelConfig() {
    ...
    properties.put(
        String.format(Constants.MIXMICRO_SINGLE_LOG_CONSOLE_SWITCH, TEST_SPACE), "true");
    properties.put(
        String.format(Constants.MIXMICRO_SINGLE_LOG_CONSOLE_LEVEL, TEST_SPACE), "debug");
    SpringApplication springApplication = new SpringApplication(EmptyConfig.class);
    springApplication.setDefaultProperties(properties);
    springApplication.run(new String[] {});
    logger.info("space console");
    ...
    LogEnvUtils.processGlobalSystemLogProperties()
        .remove(String.format(Constants.MIXMICRO_SINGLE_LOG_CONSOLE_SWITCH, TEST_SPACE));
    LogEnvUtils.processGlobalSystemLogProperties()
        .remove(String.format(Constants.MIXMICRO_SINGLE_LOG_CONSOLE_LEVEL, TEST_SPACE));
  }

  /** test mixmicro.log.console config */
  @Test
  public void testGlobalConsoleConfig() {
    Map<String, Object> properties = new HashMap<String, Object>();
    properties.put(Constants.MIXMICRO_ALL_LOG_CONSOLE_SWITCH, "true");
    SpringApplication springApplication = new SpringApplication(EmptyConfig.class);
    springApplication.setDefaultProperties(properties);
    springApplication.run(new String[] {});
    ...
    LogEnvUtils.processGlobalSystemLogProperties()
        .remove(Constants.MIXMICRO_ALL_LOG_CONSOLE_SWITCH);
  }

  /** test mixmicro.log.console.level config */
  @Test
  public void testGlobalConsoleLevelConfig() {
    Map<String, Object> properties = new HashMap<String, Object>();
    properties.put(Constants.MIXMICRO_ALL_LOG_CONSOLE_SWITCH, "true");
    properties.put(Constants.MIXMICRO_ALL_LOG_CONSOLE_LEVEL, "debug");
    SpringApplication springApplication = new SpringApplication(EmptyConfig.class);
    springApplication.setDefaultProperties(properties);
    springApplication.run(new String[] {});
    logger.info("global space console");
    ...
    LogEnvUtils.processGlobalSystemLogProperties()
        .remove(Constants.MIXMICRO_ALL_LOG_CONSOLE_SWITCH);
    LogEnvUtils.processGlobalSystemLogProperties()
        .remove(Constants.MIXMICRO_ALL_LOG_CONSOLE_LEVEL);
  }
  ...
  public void testSpaceOverrideGlobalConfig() throws IOException {
    ...
    properties.put(Constants.MIXMICRO_ALL_LOG_CONSOLE_LEVEL, "debug");
    properties.put(
        String.format(Constants.MIXMICRO_SINGLE_LOG_CONSOLE_SWITCH, TEST_SPACE), "false");
    properties.put(
        String.format(Constants.MIXMICRO_SINGLE_LOG_CONSOLE_LEVEL, TEST_SPACE), "info");
  ...
  /** test mixmicro.log.console.logback.pattern config */
  @Test
  public void testLogbackLogConsolePattern() {
    Map<String, Object> properties = new HashMap<String, Object>();
    properties.put(Constants.MIXMICRO_ALL_LOG_CONSOLE_SWITCH, "true");
    properties.put(
        Constants.MIXMICRO_LOG_CONSOLE_LOGBACK_PATTERN,
        "logback-test-console-pattern"
            + Constants.MIXMICRO_LOG_CONSOLE_LOGBACK_PATTERN_DEFAULT);
    SpringApplication springApplication = new SpringApplication(EmptyConfig.class);
    springApplication.setDefaultProperties(properties);
    springApplication.run(new String[] {});
    logger.info("global space console");
    ...
    LogEnvUtils.processGlobalSystemLogProperties()
        .remove(Constants.MIXMICRO_ALL_LOG_CONSOLE_SWITCH);
    LogEnvUtils.processGlobalSystemLogProperties()
        .remove(Constants.MIXMICRO_LOG_CONSOLE_LOGBACK_PATTERN);
  }
  ...
  public void testThreadContextConfiguration() {
    try {
      ...
      Assert.assertTrue(Constants.LOGGING_PATH_DEFAULT.equals(ThreadContext.get("logging.path")));
    } finally {
      System.getProperties().remove(Constants.LOGBACK_MIDDLEWARE_LOG_DISABLE_PROP_KEY);
    }
  }

  /** test mixmicro.log.disable */
  @Test
  public void testDisableMiddleLog() {
    Map<String, Object> properties = new HashMap<String, Object>();
    properties.put(Constants.MIXMICRO_LOG_DISABLE_PROP_KEY, "true");
    SpringApplication springApplication = new SpringApplication(EmptyConfig.class);
    springApplication.setDefaultProperties(properties);
    springApplication.run(new String[] {});
    logger.info("global space console");
    ...
    Assert.assertFalse(outContent.toString().contains("global space console debug"));
    LogEnvUtils.processGlobalSystemLogProperties()
        .remove(Constants.MIXMICRO_LOG_DISABLE_PROP_KEY);
  }
