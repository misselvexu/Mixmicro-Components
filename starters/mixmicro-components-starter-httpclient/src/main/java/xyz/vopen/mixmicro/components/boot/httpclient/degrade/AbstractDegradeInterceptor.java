...
/**
 * {@link AbstractDegradeInterceptor}
 *
 * <p>Class AbstractDegradeInterceptor Definition
 *
 * @author <a href="mailto:iskp.me@gmail.com">Elve.Xu</a>
 * @version ${project.version} - 2020/11/12
 */
public abstract class AbstractDegradeInterceptor implements Interceptor {
   ...
   * @param chain 请求执行链
   * @return 请求响应
   * @throws ClientBlockException 如果触发熔断，抛出RetrofitBlockException异常！
   * @throws IOException IOException
   */
  protected abstract Response degradeIntercept(String resourceName, Chain chain)
