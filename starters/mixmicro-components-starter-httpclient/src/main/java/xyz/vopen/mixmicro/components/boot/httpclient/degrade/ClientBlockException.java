...
/**
 * {@link ClientBlockException}
 *
 * <p>Class ClientBlockException Definition
 *
 * @author <a href="mailto:iskp.me@gmail.com">Elve.Xu</a>
 * @version ${project.version} - 2020/11/12
 */
public class ClientBlockException extends RuntimeException {
   ...
   * @since 1.4
   */
  public ClientBlockException(String message, Throwable cause) {
    super(message, cause);
  }
   ...
   * @since 1.4
   */
  public ClientBlockException(Throwable cause) {
    super(cause);
  }
