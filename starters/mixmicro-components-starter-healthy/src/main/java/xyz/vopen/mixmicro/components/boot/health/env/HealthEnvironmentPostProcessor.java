 ...
 */
package xyz.vopen.mixmicro.components.boot.health.env;
 ...
 * @since 2.1.0
 */
public class HealthEnvironmentPostProcessor
    implements EnvironmentPostProcessor, Ordered {

  /**
   * The name of MultiDataSource default {@link PropertySource}
   */
  public static final String PROPERTY_SOURCE_NAME = "mixmicro-health-default";
  ...
  public static final String RESOURCE_LOCATION_PATTERN =
      CLASSPATH_ALL_URL_PREFIX + "META-INF/mixmicro-health.properties";
