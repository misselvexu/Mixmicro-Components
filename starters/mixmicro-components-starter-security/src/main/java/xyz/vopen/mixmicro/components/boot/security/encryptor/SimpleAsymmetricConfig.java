...
/**
 * High level core class that provides a fallback mechanism to load private/public keys
...
public class SimpleAsymmetricConfig {
  ...
  private Resource loadResource(
      Resource asResource, String asString, String asLocation, KeyFormat format) {
                                ...
                                .orElseThrow(
                                    () ->
                                        new IllegalArgumentException(
                                            "Unable to load key. Either resource, key as string, or resource location must be provided"))));
  }
