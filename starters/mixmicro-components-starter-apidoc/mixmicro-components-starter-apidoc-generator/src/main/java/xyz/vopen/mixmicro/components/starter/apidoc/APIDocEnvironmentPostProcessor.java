...
public class APIDocEnvironmentPostProcessor implements EnvironmentPostProcessor, Ordered {
  ...
  public static final String PROPERTY_SOURCE_NAME = "mixmicro-apidoc-generator-default";
  ...
  public static final String RESOURCE_LOCATION_PATTERN =
      CLASSPATH_ALL_URL_PREFIX + "META-INF/mixmicro-apidoc-generator-default.properties";
