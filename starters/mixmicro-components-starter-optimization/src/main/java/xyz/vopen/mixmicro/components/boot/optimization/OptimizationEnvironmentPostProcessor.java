 ...
 */
package xyz.vopen.mixmicro.components.boot.optimization;
 ...
 * @since 2.1.0
 */
public class OptimizationEnvironmentPostProcessor implements EnvironmentPostProcessor, Ordered {

  /** The name of MultiDataSource default {@link PropertySource} */
  public static final String PROPERTY_SOURCE_NAME = "mixmicro-optimization";
   ...
   */
  public static final String RESOURCE_LOCATION_PATTERN = CLASSPATH_ALL_URL_PREFIX + "META-INF/mixmicro-optimization.properties";
  ...
  private void processPropertySource(ConfigurableEnvironment environment, ResourceLoader resourceLoader) {
    try {
      ...
      // append multiDataSourceDefaultPropertySource as last one in order to be overrided by higher order
