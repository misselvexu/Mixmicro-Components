...
public class MixmicroLoggingTracingProperties {
  ...
  private MixmicroLoggingTracingStorageWay mixmicroLoggingTracingStorageWay =
      MixmicroLoggingTracingStorageWay.MEMORY;
  ...
  /**
   * Choose load balancing strategy for admin report log {@link LoadBalanceStrategy}
   *
  ...
  /**
   * Config Mixmicro Boot Logging Discovery Instance Draw the list of Mixmicro Boot Logging Admin
   * addresses from the registry and report the request log through load balancing
   */
  @Data
