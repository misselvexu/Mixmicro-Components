...
import xyz.vopen.mixmicro.components.boot.annotation.auto.processor.service.MixmicroAutoServiceProcessor;

import java.lang.annotation.*;

/**
 * An annotation for service providers as described in {@link java.util.ServiceLoader}. The {@link
 * MixmicroAutoServiceProcessor} generates the configuration files which allows service providers to be
...
public @interface MixmicroAutoService {
  /**
