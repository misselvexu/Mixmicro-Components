package xyz.vopen.mixmicro.components.boot.annotation.auto.processor.service;

import com.google.auto.service.AutoService;
import xyz.vopen.mixmicro.components.boot.annotation.auto.processor.annotation.MixmicroAutoService;
...
public class MixmicroAutoServiceProcessor extends AbstractMixmicroProcessor {

  /** AutoService 注解名 */
  private static final String AUTO_SERVICE_NAME = MixmicroAutoService.class.getName();
  ...
  private void processAnnotations(
    ...
    for (TypeElement typeElement : typeElementSet) {
      AnnotationMirror annotationMirror =
          getAnnotation(elementUtils, typeElement, AUTO_SERVICE_NAME);
  ...
  private Set<TypeMirror> getValueFieldOfClasses(AnnotationMirror annotationMirror) {
    return getAnnotationValue(annotationMirror, "value")
        .accept(
            new SimpleAnnotationValueVisitor8<Set<TypeMirror>, Void>() {
              @Override
