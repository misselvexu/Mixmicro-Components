 ...
 */
public abstract class AbstractMixmicroProcessor extends AbstractProcessor {
   ...
   * @return {boolean}
   */
  protected AnnotationMirror getAnnotation(
      Elements elementUtils, Element e, String annotationFullName) {
