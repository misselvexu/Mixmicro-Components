...
import xyz.vopen.mixmicro.kits.retry.backoff.ExponentialBackoffStrategy;
import xyz.vopen.mixmicro.kits.retry.backoff.FibonacciBackoffStrategy;
import xyz.vopen.mixmicro.kits.retry.backoff.FixedBackoffStrategy;
...
public class RetryConfigBuilderTest_ValidationDisabledTest {
  ...
  public void testSettingRetryOnAnyException() {
    RetryConfig config = retryConfigBuilder.retryOnAnyException().build();
  ...
  public void testSettingMaxTries() {
    RetryConfig config = retryConfigBuilder.withMaxNumberOfTries(99).build();
  ...
  public void testSettingDurationBetweenTries_duration() {
    ...
    RetryConfig config = retryConfigBuilder.withDelayBetweenTries(duration).build();
  ...
  public void testSettingDurationBetweenTries_seconds() {
    RetryConfig config = retryConfigBuilder.withDelayBetweenTries(5, ChronoUnit.SECONDS).build();
  ...
  public void testSettingDurationBetweenTries_millis() {
    RetryConfig config = retryConfigBuilder.withDelayBetweenTries(5000, ChronoUnit.MILLIS).build();
  ...
  public void testSettingBackoffStrategy_exponential() {
    RetryConfig config = retryConfigBuilder.withExponentialBackoff().build();
  ...
  public void testSettingBackoffStrategy_fixed() {
    RetryConfig config = retryConfigBuilder.withFixedBackoff().build();
  ...
  public void testSettingBackoffStrategy_fibonacci() {
    RetryConfig config = retryConfigBuilder.withFibonacciBackoff().build();
