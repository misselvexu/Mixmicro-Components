package xyz.vopen.mixmicro.kits.timed;
...
/**
 * {@link TimedIdGenerator} generates 27-character, time-ordered, k-sortable, URL-safe, globally
 * unique identifiers.
 *
 ...
 */
public class TimedIdGenerator implements Externalizable {
  ...
  /** Creates a new {@link TimedIdGenerator}. */
  public TimedIdGenerator() {
    this(new SecureRandom(), Clock.systemUTC());
  }

  TimedIdGenerator(SecureRandom random, Clock clock) {
    this.clock = clock;
