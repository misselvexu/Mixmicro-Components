package xyz.vopen.mixmicro.kits.qrcode;
...
/**
 * {@link BufferedImageLuminanceSource}
 *
 * @author Mixmicro+
 */
public final class BufferedImageLuminanceSource extends LuminanceSource {
  ...
  public LuminanceSource crop(int left, int top, int width, int height) {
    return new BufferedImageLuminanceSource(
        this.image, this.left + left, this.top + top, width, height);
  }
  ...
  public LuminanceSource rotateCounterClockwise() {
    ...
    int width = getWidth();
    return new BufferedImageLuminanceSource(
        rotatedImage, this.top, sourceWidth - (this.left + width), getHeight(), width);
  }
}
