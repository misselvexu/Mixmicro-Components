...
public final class Collections {
   ...
   * pairs) over.
   *
   * <p>Uses <code>Properties.propertyNames()</code> to even catch default properties linked into
   * the original Properties instance.
   *
  ...
  /**
   * Return <code>true</code> if any element in '<code>candidates</code>' is contained in '<code>
   * source</code>'; otherwise returns <code>false</code>.
   *
