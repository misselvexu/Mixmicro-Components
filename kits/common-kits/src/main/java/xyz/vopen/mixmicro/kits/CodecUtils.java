...
public final class CodecUtils {
   ...
   * @param dstMap 目标map
   */
  public static void flatCopyTo(
      String prefix, Map<String, Object> sourceMap, Map<String, String> dstMap) {
   ...
   */
  public static void treeCopyTo(
      String prefix, Map<String, String> sourceMap, Map<String, String> dstMap, boolean remove) {
