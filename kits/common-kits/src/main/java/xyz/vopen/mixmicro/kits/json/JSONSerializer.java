  ...
  public static String serialize(Object object, boolean addType) {
    if (object == null) {
      ...
      while (itr.hasNext()) {
        ...
        sb.append(serialize(entry.getKey(), addType))
            .append(':')
            .append(serialize(entry.getValue(), addType))
            .append(',');
      }
              ...
              while (true) {
                ...
                if (nextToken() != ':') {
                  throw new ParseException(
                      new String(this.buffer), this.position, "Expected a ':' after a key");
                }
                ...
                switch (nextToken()) {
                  ...
                  default:
                    throw new ParseException(
                        new String(this.buffer), this.position, "Expected a ',' or '}'");
                }
              }
            } else {
              return map;
        ...
        case '\'':
          ...
          while (true) {
            ...
            switch (ch) {
              ...
              case '\r':
                throw new ParseException(
                    new String(this.buffer), this.position, "Unterminated string");
              case '\\': // 读到反斜杠 读取下一个位置
                ...
                switch (ch) {
                  ...
                  case 'u': // unicode
                    ...
                    for (int i = 3; i >= 0; --i) {
                      ...
                      if (tmp <= '9' && tmp >= '0') {
                        ...
                        throw new ParseException(
                            new String(this.buffer), this.position, "Illegal hex code");
                      }
                      num += tmp << (i * 4);
                    }
                    sb.append((char) num);
                  ...
                  default:
                    throw new ParseException(
                        new String(this.buffer), this.position, "Illegal escape.");
                }
                break;
              default:
                if (ch == c) {
