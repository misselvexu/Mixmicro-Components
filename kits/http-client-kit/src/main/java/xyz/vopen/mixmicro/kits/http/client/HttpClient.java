...
public class HttpClient extends AbstractHttpClient {
   ...
   */
  public void request(
      METHOD method, String url, HttpParams params, HttpOptions options, HttpResponse response) {
    ...
    if (method == METHOD.PUT) {
      execute(method, url, params, options, response);
    }
  }
   ...
   * @param response 响应
   */
  public void download(String url, HttpParams params, HttpOptions options, HttpResponse response) {
