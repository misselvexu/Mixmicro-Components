...
public class HttpResponse {
   ...
   *
   * @param needCookie is parse response cookie from <code>org.apache.http.HttpResponse</code>
   *     default <code>false</code>
   * @param needHeader is parse response header from <code>org.apache.http.HttpResponse</code>
   *     default <code>false</code>
   */
