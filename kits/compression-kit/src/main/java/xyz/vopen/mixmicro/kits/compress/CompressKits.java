...
import xyz.vopen.mixmicro.kits.compress.bean.CompressionType;
import xyz.vopen.mixmicro.kits.compress.bean.ZipLevel;
import xyz.vopen.mixmicro.kits.compress.compressor.FileCompressor;
import xyz.vopen.mixmicro.kits.compress.exception.CompressException;
import xyz.vopen.mixmicro.kits.compress.tar.TarUtils;
 ...
 */
public final class CompressKits {

  private static final Logger log = LoggerFactory.getLogger(CompressKits.class);
   ...
   * @exception Exception compress exception
   */
