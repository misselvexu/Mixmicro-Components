package xyz.vopen.mixmicro.kits.compress.compressor;

import xyz.vopen.mixmicro.kits.compress.CompressProcessor;
import xyz.vopen.mixmicro.kits.compress.bean.BinaryFile;
import xyz.vopen.mixmicro.kits.compress.bean.CompressionLevel;
...
import xyz.vopen.mixmicro.kits.compress.kits.Constants.FILE_TYPES_ALLOW;
import xyz.vopen.mixmicro.kits.compress.kits.Constants.SOURCE;
...
public class FileCompressor implements Serializable {
  ...
  public static void validateAllowCompressing(CompressionType type) throws Exception {
    if (FILE_TYPES_ALLOW.COMPRESSING.contains(type)) return;
