...
public interface MappedPageFactory {
  ...
  /**
   * Return the mapped page to the factory, calling thread release the page to inform the factory
   * that it has finished with the page, so the factory get a chance to recycle the page to save
   * memory.
   *
   * @param index the index of the page
   */
  ...
  /**
   * delete a mapped page with specific index in this factory, this call will remove the page from
   * the cache if it is cached and delete back file.
   *
   * @param index the index of the page
  ...
  /**
   * delete mapped pages with a set of specific indexes in this factory, this call will remove the
   * pages from the cache if they ware cached and delete back files.
   *
  ...
  /**
   * delete all mapped pages currently available in this factory, this call will remove all pages
   * from the cache and delete all back files.
   *
   * @throws IOException exception thrown if there was any IO error during the delete operation.
   */
