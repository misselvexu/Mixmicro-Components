 ...
 * only limited by the available disk space.
 *
 * @author <a href="mailto:iskp.me@gmail.com">Elve.Xu</a>
 */
public class DefaultBigQueue implements BigQueue {
  ...
  /**
   * A big, fast and persistent queue implementation, use default back data page size, see {@link
   * DefaultBigArray#DEFAULT_DATA_PAGE_SIZE}
   *
   ...
   */
  public DefaultBigQueue(String queueDir, String queueName) throws IOException {
   ...
   * @throws IOException exception throws if there is any IO error during queue initialization
   */
  public DefaultBigQueue(String queueDir, String queueName, int pageSize) throws IOException {
    ...
    this.queueFrontIndexPageFactory =
        new DefaultMappedPageFactory(
            QUEUE_FRONT_INDEX_PAGE_SIZE,
            ((DefaultBigArray) innerArray).getArrayDirectory() + QUEUE_FRONT_INDEX_PAGE_FOLDER,
            10 * 1000 /*does not matter*/);
    MappedPage queueFrontIndexPage =
        this.queueFrontIndexPageFactory.acquirePage(QUEUE_FRONT_PAGE_INDEX);
