package xyz.vopen.mixmicro.kits.queue.load;
...
import xyz.vopen.mixmicro.kits.queue.DefaultBigQueue;
import xyz.vopen.mixmicro.kits.queue.BigQueue;
...
public class BigQueueLoadTest {
	...
	public void runTest() throws Exception {
		bigQueue = new DefaultBigQueue(testDir, "load_test");
