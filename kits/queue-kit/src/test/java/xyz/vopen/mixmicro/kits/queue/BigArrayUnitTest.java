...
public class BigArrayUnitTest {
	...
	public void simpleTest() throws IOException {
	    bigArray = new DefaultBigArray(testDir, "simple_test");
	...
	public void removeBeforeIndexTest() throws IOException {
	    bigArray = new DefaultBigArray(testDir, "remove_before_index_test");
		assertNotNull(bigArray);
	...
	public void removeBeforeTest() throws IOException {
	    bigArray = new DefaultBigArray(testDir, "remove_before_test");
		assertNotNull(bigArray);
	...
	public void bigLoopTest() throws IOException {
	    bigArray = new DefaultBigArray(testDir, "big_loop_test");
		assertNotNull(bigArray);
	...
	public void loopTimingTest() throws IOException {
	    bigArray = new DefaultBigArray(testDir, "loop_timing_test");
		assertNotNull(bigArray);
	...
	public void getClosestIndexTest() throws IOException {
	    bigArray = new DefaultBigArray(testDir, "get_closest_index_test");
		assertNotNull(bigArray);
	...
	public void getBackFileSizeTest() throws IOException {
	    bigArray = new DefaultBigArray(testDir, "get_back_file_size_test");
		assertNotNull(bigArray);
		
		assertTrue(bigArray.getBackFileSize() == 0);
		
		bigArray.append("hello".getBytes());
		assertTrue(bigArray.getBackFileSize() == DefaultBigArray.INDEX_PAGE_SIZE + bigArray.getDataPageSize());
		...
		long expectedSize = DefaultBigArray.INDEX_PAGE_SIZE * 23 + bigArray.getDataPageSize() * 6;
		...
		expectedSize = DefaultBigArray.INDEX_PAGE_SIZE * 12 + bigArray.getDataPageSize() * 4;
	...
	public void limitBackFileSize() throws IOException {
	    bigArray = new DefaultBigArray(testDir, "limit_back_file_size_test");
		assertNotNull(bigArray);
		...
		bigArray.limitBackFileSize(DefaultBigArray.INDEX_PAGE_SIZE * 12 + bigArray.getDataPageSize() * 3);
		assertTrue(bigArray.getBackFileSize() <= DefaultBigArray.INDEX_PAGE_SIZE * 12 + bigArray.getDataPageSize() * 3);
		assertTrue(bigArray.getBackFileSize() > DefaultBigArray.INDEX_PAGE_SIZE * 11 + bigArray.getDataPageSize() * 2);
		long lastTailIndex = bigArray.getTailIndex();
		assertTrue(lastTailIndex > 0);
		assertTrue(bigArray.getHeadIndex() == loop + 1);
		
		bigArray.limitBackFileSize(DefaultBigArray.INDEX_PAGE_SIZE * 8 + bigArray.getDataPageSize() * 2);
		assertTrue(bigArray.getBackFileSize() <= DefaultBigArray.INDEX_PAGE_SIZE * 8 + bigArray.getDataPageSize() * 2);
		assertTrue(bigArray.getBackFileSize() > DefaultBigArray.INDEX_PAGE_SIZE * 7 + bigArray.getDataPageSize());
		assertTrue(bigArray.getTailIndex() > lastTailIndex);
		lastTailIndex = bigArray.getTailIndex();
		assertTrue(bigArray.getHeadIndex() == loop + 1);
		
		bigArray.limitBackFileSize(DefaultBigArray.INDEX_PAGE_SIZE * 4 + bigArray.getDataPageSize());
		assertTrue(bigArray.getBackFileSize() == DefaultBigArray.INDEX_PAGE_SIZE * 3 + bigArray.getDataPageSize());
		assertTrue(bigArray.getTailIndex() > lastTailIndex);
		lastTailIndex = bigArray.getTailIndex();
		assertTrue(bigArray.getHeadIndex() == loop + 1);
	...
	public void getItemLength() throws IOException {
		bigArray = new DefaultBigArray(testDir, "get_data_length_test");
		assertNotNull(bigArray);
	...
	public void testInvalidDataPageSize() throws IOException {
		try {
			bigArray = new DefaultBigArray(testDir, "invalid_data_page_size", DefaultBigArray.MINIMUM_DATA_PAGE_SIZE - 1);
	...
	public void testMinimumDataPageSize() throws IOException {
		bigArray = new DefaultBigArray(testDir, "min_data_page_size", DefaultBigArray.MINIMUM_DATA_PAGE_SIZE);
		
		String randomString = TestUtil.randomString(DefaultBigArray.MINIMUM_DATA_PAGE_SIZE / (1024 * 1024));
    ...
    public void testRemoveBeforeIndexDataCorruption() throws IOException, InterruptedException {
        bigArray = new DefaultBigArray(tempDir.newFolder().getAbsolutePath(), "data_corruption", DefaultBigArray.DEFAULT_DATA_PAGE_SIZE);
