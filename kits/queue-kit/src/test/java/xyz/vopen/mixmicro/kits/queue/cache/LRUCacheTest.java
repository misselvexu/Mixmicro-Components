...
public class LRUCacheTest {
	...
	public void singleThreadTest() {
		...
		LRUCache<Integer, TestObject> cache = new DefaultLRUCache<Integer, TestObject>();
	...
	public void multiThreadsTest() {
		...
		cache = new DefaultLRUCache<Integer, TestObject>();
		threadNum = 100;
	...
	private static class Worker extends Thread {
		private int id;
		private LRUCache<Integer, TestObject> cache;
		
		public Worker(int id, LRUCache<Integer, TestObject> cache) {
			this.id = id;
			this.cache = cache;
		}
	...
	private static class RandomWorker extends Thread {
		...
		public RandomWorker(int idLimit, LRUCache<Integer, TestObject> cache) {
