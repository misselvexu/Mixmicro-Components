...
import xyz.vopen.mixmicro.kits.spring.util.AnnotationUtils;
...
/**
 * Abstract common {@link BeanPostProcessor} implementation for customized annotation that annotated
 * injected-object.
 *
...
public abstract class AbstractAnnotationBeanPostProcessor
  ...
  private final ConcurrentMap<String, AbstractAnnotationBeanPostProcessor.AnnotatedInjectionMetadata> injectionMetadataCache = new ConcurrentHashMap<
   ...
   */
  private List<AbstractAnnotationBeanPostProcessor.AnnotatedFieldElement>
      findFieldAnnotationMetadata(final Class<?> beanClass) {

    final List<AbstractAnnotationBeanPostProcessor.AnnotatedFieldElement> elements =
        new LinkedList<AbstractAnnotationBeanPostProcessor.AnnotatedFieldElement>();
            ...
            for (Class<? extends Annotation> annotationType : getAnnotationTypes()) {
              ...
              AnnotationAttributes attributes =
                  AnnotationUtils.getAnnotationAttributes(
                      field, annotationType, getEnvironment(), true, true);
  ...
  private List<AbstractAnnotationBeanPostProcessor.AnnotatedMethodElement>
    ...
    final List<AbstractAnnotationBeanPostProcessor.AnnotatedMethodElement> elements =
        new LinkedList<AbstractAnnotationBeanPostProcessor.AnnotatedMethodElement>();
  ...
  private AbstractAnnotationBeanPostProcessor.AnnotatedInjectionMetadata buildAnnotatedMetadata(
    ...
    return new AbstractAnnotationBeanPostProcessor.AnnotatedInjectionMetadata(
        beanClass, fieldElements, methodElements);
  }
  ...
  /**
   * Get injected-object from specified {@link AnnotationAttributes annotation attributes} and Bean
   * Class
   *
   ...
   */
  protected abstract String buildInjectedObjectCacheKey(
      AnnotationAttributes attributes,
      Object bean,
      String beanName,
      Class<?> injectedType,
  ...
  protected Map<InjectionMetadata.InjectedElement, Object> getInjectedFieldObjectsMap() {
    ...
    for (AbstractAnnotationBeanPostProcessor.AnnotatedInjectionMetadata metadata :
  ...
  protected Map<InjectionMetadata.InjectedElement, Object> getInjectedMethodObjectsMap() {
    ...
    for (AbstractAnnotationBeanPostProcessor.AnnotatedInjectionMetadata metadata :
      ...
      for (AbstractAnnotationBeanPostProcessor.AnnotatedMethodElement methodElement :
          methodElements) {
  ...
  private class AnnotatedInjectionMetadata extends InjectionMetadata {
    ...
    private final Collection<AbstractAnnotationBeanPostProcessor.AnnotatedFieldElement>
        fieldElements;

    private final Collection<AbstractAnnotationBeanPostProcessor.AnnotatedMethodElement>
        methodElements;
    ...
    public Collection<AbstractAnnotationBeanPostProcessor.AnnotatedFieldElement>
        getFieldElements() {
      return fieldElements;
    }

    public Collection<AbstractAnnotationBeanPostProcessor.AnnotatedMethodElement>
        getMethodElements() {
  ...
  private class AnnotatedMethodElement extends InjectionMetadata.InjectedElement {
    ...
    protected AnnotatedMethodElement(
        Method method, PropertyDescriptor pd, AnnotationAttributes attributes) {
      super(method, pd);
      this.method = method;
