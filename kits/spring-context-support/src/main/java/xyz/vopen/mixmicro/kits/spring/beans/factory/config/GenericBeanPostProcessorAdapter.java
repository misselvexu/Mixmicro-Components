package xyz.vopen.mixmicro.kits.spring.beans.factory.config;
...
public abstract class GenericBeanPostProcessorAdapter<T> implements BeanPostProcessor {
   ...
   *
   * <p>This method will be invoked by BeanPostProcessor#postProcessBeforeInitialization(Object,
   * String)
   *
   * @param bean Bean Object
   * @param beanName Bean Name
   ...
   *
   * <p>This method will be invoked by BeanPostProcessor#postProcessAfterInitialization(Object,
   * String)
   *
   * @param bean Bean Object
   * @param beanName Bean Name
