...
/**
 * Abstract generic {@link BeanPostProcessor} implementation for customized annotation that
 * annotated injected-object.
 *
...
public abstract class AnnotationInjectedBeanPostProcessor<A extends Annotation>
  ...
  private final ConcurrentMap<String, Object> injectedObjectsCache =
      new ConcurrentHashMap<String, Object>(CACHE_SIZE);
  ...
  public AnnotationInjectedBeanPostProcessor() {
    this.annotationType =
        xyz.vopen.mixmicro.kits.spring.util.ClassUtils.resolveGenericType(getClass());
  }
  ...
  public PropertyValues postProcessPropertyValues(
    ...
    try {
      ...
      throw new BeanCreationException(
          beanName,
          "Injection of @" + getAnnotationType().getName() + " dependencies is failed",
          ex);
    }
    return pvs;
  }
        ...
        if (InjectionMetadata.needsRefresh(metadata, clazz)) {
          ...
          try {
            ...
            throw new IllegalStateException(
                "Failed to introspect object class ["
                    + clazz.getName()
  ...
  protected Object getInjectedObject(
    ...
    String cacheKey =
        buildInjectedObjectCacheKey(annotation, bean, beanName, injectedType, injectedElement);
