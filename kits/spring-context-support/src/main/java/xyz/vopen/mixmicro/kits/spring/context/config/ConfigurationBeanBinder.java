...
import xyz.vopen.mixmicro.kits.spring.beans.factory.annotation.EnableConfigurationBeanBinding;
...
public interface ConfigurationBeanBinder {
   ...
   * @param ignoreUnknownFields whether to ignore unknown fields, the value is come from the
   *     attribute of {@link EnableConfigurationBeanBinding#ignoreUnknownFields()}
   * @param ignoreInvalidFields whether to ignore invalid fields, the value is come from the
   *     attribute of {@link EnableConfigurationBeanBinding#ignoreInvalidFields()}
