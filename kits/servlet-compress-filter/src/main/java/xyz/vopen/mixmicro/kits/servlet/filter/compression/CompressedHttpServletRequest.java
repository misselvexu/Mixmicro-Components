/*
 * Copyright 2006 and onwards Elve.Xu
 *
...
/**
 * Implementation of {@link HttpServletRequest} which can decompress request bodies that have been
 * compressed.
 *
 * @author Elve.Xu
 * @since 1.6
...
final class CompressedHttpServletRequest extends HttpServletRequestWrapper {
  ...
  public BufferedReader getReader() throws IOException {
    ...
    if (bufferedReader == null) {
      bufferedReader =
          new BufferedReader(
              new InputStreamReader(getCompressingServletInputStream(), getCharacterEncoding()));
    }
  ...
  private CompressingServletInputStream getCompressingServletInputStream() throws IOException {
    if (compressedSIS == null) {
      compressedSIS =
          new CompressingServletInputStream(
              httpRequest.getInputStream(), compressingStreamFactory, context);
    }
