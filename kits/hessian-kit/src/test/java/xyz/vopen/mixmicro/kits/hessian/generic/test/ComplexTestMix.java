...
public class ComplexTestMix {
  ...
  public void testGOGO2GOO() throws IOException {
    ...
    ComplexTestGO2GO.cmpGPersonEqualPerson((GenericObject) garr[2][1], (Person) arr[2][1]);
    ComplexTestGO2GO.cmpGPersonEqualPerson((GenericObject) garr[2][2], (Person) arr[2][2]);
    ...
    ComplexTestGO2GO.cmpGPersonEqualPerson((GenericObject) garr1[0], (Person) arr1[0]);
    ...
    ComplexTestGO2GO.cmpGPersonEqualPerson((GenericObject) garr1[1], (Person) arr1[1]);
    // check the same object for generic hessian
  ...
  public void testSofaRequest() throws IOException {
    ...
    ComplexTestGO2GO.cmpGPersonEqualPerson(
        (GenericObject) request.getMethodArgs()[0], (Person) deRequest.getMethodArgs()[0]);
  ...
  public void testSofaResponse() throws IOException {
    ...
    ComplexTestGO2GO.cmpGPersonEqualPerson(
        (GenericObject) deResponse.getField("appResponse"), (Person) response.getAppResponse());
  }
}
