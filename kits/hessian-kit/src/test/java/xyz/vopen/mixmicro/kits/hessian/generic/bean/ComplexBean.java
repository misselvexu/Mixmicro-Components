...
public class ComplexBean implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    if (person2 != null ? !person2.equals(that.person2) : that.person2 != null) return false;
    // Probably incorrect - comparing Object[] arrays with Arrays.equals
    if (!Arrays.equals(str1, that.str1)) return false;
    // Probably incorrect - comparing Object[] arrays with Arrays.equals
    if (!Arrays.equals(str2, that.str2)) return false;
    ...
    return genericObject != null
        ? genericObject.equals(that.genericObject)
