...
/** Created by qiwei.lqw on 2016/7/5. Serialize: Hessian --> Deserialize: GenericHessian */
public class ComplexTestO2GO {
  ...
  public void testMap() throws IOException {
    ...
    ComplexTestGO2GO.cmpGPersonEqualPerson(
        (GenericObject) dmap2.get("lll"), (Person) map2.get("lll"));
    ComplexTestGO2GO.cmpGPersonEqualPerson(
        (GenericObject) dmap2.get("qqq"), (Person) map2.get("qqq"));
    ComplexTestGO2GO.cmpGPersonEqualPerson(
        (GenericObject) dmap2.get("www"), (Person) map2.get("www"));
  ...
  public void testList() throws IOException {
    ...
    ComplexTestGO2GO.cmpGPersonEqualPerson((GenericObject) dlist2.get(0), (Person) list2.get(0));
    ComplexTestGO2GO.cmpGPersonEqualPerson((GenericObject) dlist2.get(1), (Person) list2.get(1));
    ComplexTestGO2GO.cmpGPersonEqualPerson((GenericObject) dlist2.get(2), (Person) list2.get(2));
  ...
  public void testMix() throws IOException {
    ...
    ComplexTestGO2GO.cmpGPersonEqualPerson(
        (GenericObject) darr1[0], (Person) ((Object[]) arr[1][0])[0]);
    ...
    ComplexTestGO2GO.cmpGPersonEqualPerson(
        (GenericObject) darr1[1], (Person) ((Object[]) arr[1][0])[1]);
