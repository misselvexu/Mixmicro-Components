...
import xyz.vopen.mixmicro.kits.hessian.generic.bean.ComplexBean;
...
public class CollectionTest {
  ...
  public void testCollection() throws Exception {
    ...
    assertEquals(
        ((ArrayList) genericCollection.getCollection()).get(1).getClass(), GenericObject.class);

    GenericObject genericObject =
        (GenericObject) ((ArrayList) genericCollection.getCollection()).get(1);
  ...
  private void assertGenericComplexBean(Object o) {
    ...
    assertEquals(
        ((GenericCollection) result.getField("testList1")).getType(), TestList.class.getName());
    assertEquals(
        ((GenericCollection) result.getField("testList2")).getType(), TestList.class.getName());
    ...
    assertEquals(
        GenericObject.class.getName(), result.getField("genericObject").getClass().getName());
    assertEquals(
    ...
    assertEquals(
        ...
        ((GenericObject) result.getField("genericObject")).getField("fields").getClass().getName());
    assertEquals(
        "zhao",
