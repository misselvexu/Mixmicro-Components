...
public class SpecialClassTest {
  ...
  public void testSpecialBean() throws Exception {
    ...
    assertEquals(GenericObject.class, o.getClass());
    assertEquals(
        GenericClass.class.getName(), ((GenericObject) o).getField("clazz").getClass().getName());
    ...
    o = hin.readObject();
    assertEquals(GenericObject.class, o.getClass());
    assertEquals(Class.class.getName(), ((GenericObject) o).getField("clazz").getClass().getName());
