...
/** Created by qiwei.lqw on 2016/7/5. Serialize: GenericHessian --> Deserialize: Hessian */
public class ComplexTestGO2O {
  ...
  public void testMap() throws IOException {
    ...
    ComplexTestGO2GO.cmpGPersonEqualPerson((GenericObject) ((Map) go).get(1), (Person) dmap.get(1));
    ComplexTestGO2GO.cmpGPersonEqualPerson((GenericObject) ((Map) go).get(2), (Person) dmap.get(2));
    ...
    ComplexTestGO2GO.cmpGPersonEqualPerson(
        (GenericObject) map2.get("lll"), (Person) dmap2.get("lll"));
    ComplexTestGO2GO.cmpGPersonEqualPerson(
        (GenericObject) map2.get("qqq"), (Person) dmap2.get("qqq"));
    ComplexTestGO2GO.cmpGPersonEqualPerson(
        (GenericObject) map2.get("www"), (Person) dmap2.get("www"));
  ...
  public void testList() throws IOException {
    ...
    ComplexTestGO2GO.cmpGPersonEqualPerson(
        (GenericObject) ((List) go).get(0), (Person) dlist.get(0));
    ComplexTestGO2GO.cmpGPersonEqualPerson(
        (GenericObject) ((List) go).get(1), (Person) dlist.get(1));

    List dlist2 = (List) dlist.get(2);
    List list2 = (List) ((List) go).get(2);

    assertEquals(dlist2.size(), list2.size());
    ComplexTestGO2GO.cmpGPersonEqualPerson((GenericObject) list2.get(0), (Person) dlist2.get(0));
    ComplexTestGO2GO.cmpGPersonEqualPerson((GenericObject) list2.get(1), (Person) dlist2.get(1));
    ComplexTestGO2GO.cmpGPersonEqualPerson((GenericObject) list2.get(2), (Person) dlist2.get(2));
  ...
  public void testArray() throws IOException {
    ...
    ComplexTestGO2GO.cmpGPersonEqualPerson((GenericObject) ((Object[]) go)[0], (Person) darr[0]);
    ComplexTestGO2GO.cmpGPersonEqualPerson((GenericObject) ((Object[]) go)[1], (Person) darr[1]);
  ...
  public void testMix() throws IOException {
    ...
    ComplexTestGO2GO.cmpGPersonEqualPerson(
        (GenericObject) ((Object[][]) obj)[2][1], (Person) darr[2][1]);
    ComplexTestGO2GO.cmpGPersonEqualPerson(
        (GenericObject) ((Object[][]) obj)[2][2], (Person) darr[2][2]);
