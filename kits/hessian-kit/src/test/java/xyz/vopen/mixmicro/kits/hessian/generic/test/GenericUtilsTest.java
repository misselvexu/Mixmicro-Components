...
import xyz.vopen.mixmicro.kits.hessian.generic.bean.CollectionBean;
import xyz.vopen.mixmicro.kits.hessian.generic.bean.SimplePerson;
import xyz.vopen.mixmicro.kits.hessian.generic.bean.TestList;
import xyz.vopen.mixmicro.kits.hessian.generic.bean.TestMap;
...
import static xyz.vopen.mixmicro.kits.hessian.generic.test.ComplexTestGO2GO.cmpGPersonEqualPerson;
...
public class GenericUtilsTest {
  ...
  public void singlePerson() throws IOException {
    ...
    assertEqualsResult(
        (Person) dg.generatePerson_1(), (GenericObject) dg.generateGenericPerson_1());

    assertEqualsResult(
        (Person) dg.generatePerson_2(), (GenericObject) dg.generateGenericPerson_2());

    assertEqualsResult(
        (Person) dg.generatePerson_3(), (GenericObject) dg.generateGenericPerson_3());

    assertEqualsResult(
        (Person) dg.generatePerson_4(), (GenericObject) dg.generateGenericPerson_4());

    assertEqualsResult(
        (Person) dg.generatePerson_5(), (GenericObject) dg.generateGenericPerson_5());

    assertEqualsResult(
        (Person) dg.generatePerson_6(), (GenericObject) dg.generateGenericPerson_6());
  }
  ...
  public void singleMapAndCollection() throws IOException {
    assertEqualsResult(
        (Person) dg.generatePersonWithCollection(),
  ...
  private void testCollectionBeanResult(Object obj) {
    ...
    assertEquals(
        new SimplePerson("li", "teacher"), collectionBean.getSimplePersonTestList().get(0));
    ...
    assertEquals(
        new SimplePerson("zhao", "coder"), collectionBean.getSimplePersonTestMap().get("123"));
  }
  ...
  private void testCollectionGenericResult(GenericObject genericObject) {
    ...
    assertEquals(
        GenericCollection.class.getName(),
        genericObject.getField("stringTestList").getClass().getName());
    assertEquals(
        "12345",
        ((ArrayList) ((GenericCollection) genericObject.getField("stringTestList")).getCollection())
            .get(0));
    ...
    assertEquals(
        go,
        ((ArrayList)
                ((GenericCollection) genericObject.getField("simplePersonTestList"))
                    .getCollection())
            .get(0));
    ...
    assertEquals(
        GenericArray.class.getName(),
        genericObject.getField("simplePersonArray").getClass().getName());
    go = new GenericObject(SimplePerson.class.getName());
    go.putField("name", "cao");
    go.putField("job", "coder");
    assertEquals(go, ((GenericArray) genericObject.getField("simplePersonArray")).getObjects()[0]);

    assertEquals(
        GenericMap.class.getName(),
        genericObject.getField("simplePersonTestMap").getClass().getName());
    go = new GenericObject(SimplePerson.class.getName());
    go.putField("name", "zhao");
    go.putField("job", "coder");
    assertEquals(
        go, ((GenericMap) genericObject.getField("simplePersonTestMap")).getMap().get("123"));
  }
}
