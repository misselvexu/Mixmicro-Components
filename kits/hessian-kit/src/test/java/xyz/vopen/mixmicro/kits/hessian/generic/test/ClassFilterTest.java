...
public class ClassFilterTest {
  ...
  public void testArrayFilter() throws ClassNotFoundException {
    ...
    assertEquals("[Lcom.alipay.hessian.generic.bean.SimplePerson;", SimplePerson[].class.getName());
    assertEquals(
        "[[Lcom.alipay.hessian.generic.bean.SimplePerson;", SimplePerson[][].class.getName());
    assertEquals(
        "[[[Lcom.alipay.hessian.generic.bean.SimplePerson;", SimplePerson[][][].class.getName());

    assertEquals(
        Class.forName("[Lcom.alipay.hessian.generic.bean.SimplePerson;"), SimplePerson[].class);
    assertEquals(
        Class.forName("[[Lcom.alipay.hessian.generic.bean.SimplePerson;"), SimplePerson[][].class);
    assertEquals(
        Class.forName("[[[Lcom.alipay.hessian.generic.bean.SimplePerson;"),
        SimplePerson[][][].class);
  }
