 ...
 */
package xyz.vopen.mixmicro.kits.hessian.generic.test;

import xyz.vopen.mixmicro.kits.hessian.generic.bean.ArrayBean;
import xyz.vopen.mixmicro.kits.hessian.generic.bean.SimplePerson;
...
import xyz.vopen.mixmicro.kits.hessian.generic.util.GenericUtils;
...
public class TestArray {
  ...
  public void testGenericObjectArray() throws IOException {
    ...
    ComplexTestGO2GO.cmpGPersonEqualPerson(gpArr[0], (Person) pArr[0]);
    ComplexTestGO2GO.cmpGPersonEqualPerson(gpArr[1], (Person) pArr[1]);
    ComplexTestGO2GO.cmpGPersonEqualPerson(gpArr[2], (Person) pArr[2]);
  }
  ...
  public void testGenericArray() throws IOException {
    ...
    ComplexTestGO2GO.cmpGPersonEqualPerson((GenericObject) ga.get(0), (Person) pArr[0]);
    ComplexTestGO2GO.cmpGPersonEqualPerson((GenericObject) ga.get(1), (Person) pArr[1]);
    ComplexTestGO2GO.cmpGPersonEqualPerson((GenericObject) ga.get(2), (Person) pArr[2]);
  }
  ...
  public void testGenericArrayDes() throws IOException {
    ...
    ComplexTestGO2GO.cmpGPersonEqualPerson(
        (GenericObject) pArr.get(0), (Person) dg.generatePerson_4());
    ComplexTestGO2GO.cmpGPersonEqualPerson(
        (GenericObject) pArr.get(1), (Person) dg.generatePerson_5());
    ComplexTestGO2GO.cmpGPersonEqualPerson(
        (GenericObject) pArr.get(2), (Person) dg.generatePerson_6());
  }
  ...
  private void assertGenericArrayBean(GenericObject genericObject) {
    ...
    assertEquals(String[][].class.getName(), genericObject.getField("str2").getClass().getName());
    ...
    assertEquals(String[][][].class.getName(), genericObject.getField("str3").getClass().getName());
    ...
    assertEquals(
        GenericArray.class.getName(), genericObject.getField("simplePerson1").getClass().getName());
    ...
    assertEquals(1, ((GenericArray) genericObject.getField("simplePerson1")).getObjects().length);

    assertEquals(
        GenericArray.class.getName(), genericObject.getField("simplePerson2").getClass().getName());
    assertEquals(2, ((GenericArray) genericObject.getField("simplePerson2")).getObjects().length);
    assertEquals(
        GenericArray.class,
        ((GenericArray) genericObject.getField("simplePerson2")).getObjects()[1].getClass());
    assertEquals(
        null,
        ((GenericArray) ((GenericArray) genericObject.getField("simplePerson2")).getObjects()[1])
            .getObjects()[0]);
    ...
    assertEquals(
        go,
        ((GenericArray) ((GenericArray) genericObject.getField("simplePerson2")).getObjects()[0])
            .getObjects()[0]);

    assertEquals(
        GenericArray.class.getName(), genericObject.getField("simplePerson3").getClass().getName());
    assertEquals(2, ((GenericArray) genericObject.getField("simplePerson3")).getObjects().length);
    go = new GenericObject(SimplePerson.class.getName());
    ...
    assertEquals(
        ...
        ((GenericArray)
                ((GenericArray)
                        ((GenericArray) genericObject.getField("simplePerson3")).getObjects()[1])
                    .getObjects()[0])
            .getObjects()[0]);

    assertEquals(GenericArray.class.getName(), genericObject.getField("obj1").getClass().getName());
    ...
    assertEquals(GenericArray.class.getName(), genericObject.getField("obj2").getClass().getName());
    assertEquals(
        "22",
    ...
    assertEquals(GenericArray.class.getName(), genericObject.getField("obj3").getClass().getName());
    assertEquals(
        go,
        ((GenericArray)
                ((GenericArray) ((GenericArray) genericObject.getField("obj3")).getObjects()[0])
                    .getObjects()[1])
            .getObjects()[2]);
    assertEquals(
        "11",
    ...
    assertEquals(
        null,
        ((GenericArray)
                ((GenericArray) ((GenericArray) genericObject.getField("obj3")).getObjects()[1])
                    .getObjects()[0])
            .getObjects()[0]);
  }
  ...
  private ArrayBean createArrayBean() {
    ...
    arrayBean.setStr3(new String[][][] {{{null, "11"}}, {{"33", "44", null}, {"11"}}});

    arrayBean.setSimplePerson1(new SimplePerson[] {new SimplePerson("wang", "coder")});
    arrayBean.setSimplePerson2(new SimplePerson[][] {{new SimplePerson("li", "coder")}, {null}});
    arrayBean.setSimplePerson3(
        new SimplePerson[][][] {
    ...
    arrayBean.setObj2(
        new Object[][] {{"11", 1, null}, {"22", 2, new SimplePerson("qian", "coder")}});
    arrayBean.setObj3(
        new Object[][][] {
