 ...
 */
package xyz.vopen.mixmicro.kits.hessian.generic.list;
...
import xyz.vopen.mixmicro.kits.hessian.generic.util.CustomConverter;
...
public class MyListTest {
  ...
  public void testAll() throws Exception {
    ...
    GenericUtils.addCustomConverter(
        new CustomConverter() {
          @Override
          ...
          public GenericObject convertToGenericObject(Class clazz, Object object) {
            GenericObject genericObject = new GenericObject("MyList");
    ...
    Assert.assertEquals("MyList", genericObject.getType());
