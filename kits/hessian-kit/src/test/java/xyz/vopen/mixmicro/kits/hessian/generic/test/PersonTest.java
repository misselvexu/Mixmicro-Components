...
import xyz.vopen.mixmicro.kits.hessian.generic.io.GenericObjectSerializer;
...
public class PersonTest {
  ...
  static {
    try {
      WRITE_DEFINITION_EVERYTIME_FIELD =
          GenericObjectSerializer.class.getDeclaredField("WRITE_DEFINITION_EVERYTIME");
