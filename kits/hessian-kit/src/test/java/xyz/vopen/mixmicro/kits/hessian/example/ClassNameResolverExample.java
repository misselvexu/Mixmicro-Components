...
import xyz.vopen.mixmicro.kits.hessian.ClassNameFilter;
...
public class ClassNameResolverExample {
  ...
  public static void main(String[] args) throws IOException {
    ...
    try {
      ...
      hout.writeObject(
          new Socket()); // will throw an exception because java.net.Socket is in the serialize
                         // blacklist
      hout.close();
    } catch (Exception e) {
      e.printStackTrace();
    ...
    try {
      ...
      hout.setSerializerFactory(serializerFactory);
      hout.writeObject(
          new Thread()); // will throw an exception because java.net.Thread is not allowed
      hout.close();
    } catch (Exception e) {
      e.printStackTrace();
    }
