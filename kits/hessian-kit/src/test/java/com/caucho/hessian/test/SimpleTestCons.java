...
public class SimpleTestCons implements java.io.Serializable {
  ...
  public String toString(HashMap map) {
    ...
    if (_first instanceof SimpleTestCons) sb.append(((SimpleTestCons) _first).toString(map));
    else sb.append(_first);

    sb.append(",");

    if (_rest instanceof SimpleTestCons) sb.append(((SimpleTestCons) _rest).toString(map));
