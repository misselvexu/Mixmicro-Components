...
/**
 * The test service is a Hessian 2.0 protocol test for developers of Hessian 2.0 clients. For a new
 * client the recommended order is:
 *
 * <ul>
 *   <li>methodNull
 *   <li>methodHello
...
public class TestHessian2Servlet extends HessianServlet implements TestHessian2 {
  ...
  @Override
  public void invoke(
      InputStream is, OutputStream os, String objectId, SerializerFactory serializerFactory)
      throws Exception {
