...
/**
 * The Test service is a quick sanity check service. Developers of a new Hessian implementation can
 * use this service as an initial test.
 *
 * <p>http://hessian.caucho.com/test/test2
 */
public interface TestHessian2 {
  /**
   * trivial null method call <code><pre>
   * H x02 x00
   * C
   *   x0a methodNull
   *   x90
  ...
  /**
   * Result of integer 0x30 <code><pre>
   * R xc8 x30
   * </pre></code>
   */
  ...
  /**
   * Result of integer x7ff <code><pre>
   * R xcf xff
   * </pre></code>
   */
  ...
  /**
   * Result of integer -0x800 <code><pre>
   * R xc0 x00
   * </pre></code>
   */
  ...
  /**
   * Result of integer 0x3ffff <code><pre>
   * R xd7 xff xff
   * </pre></code>
   */
  ...
  /**
   * Result of integer -0x801 <code><pre>
   * R xd3 xf8 x00
   * </pre></code>
   */
  ...
  /**
   * Result of integer m0x40000 <code><pre>
   * R xd0 x00 x00
   * </pre></code>
   */
  ...
  /**
   * Result of integer 0x40000 <code><pre>
   * R I x00 x04 x00 x00
   * </pre></code>
   */
  ...
  /**
   * Result of integer 0x7fffffff <code><pre>
   * R I x7f xff xff xff
   * </pre></code>
   */
  ...
  /**
   * Result of integer m0x40001 <code><pre>
   * R I xff xf3 xff xf
   * </pre></code>
   */
  ...
  /**
   * Result of integer -0x80000000 <code><pre>
   * R I x80 x00 x00 x00
   * </pre></code>
   */
  ...
  /**
   * Result of long 0x3ffff <code><pre>
   * R x3f xff xff
   * </pre></code>
   */
  ...
  /**
   * Result of long m0x40000 <code><pre>
   * R x38 x00 x00
   * </pre></code>
   */
  ...
  /**
   * Result of long 0x40000 <code><pre>
  ...
  /**
   * Result of long 0x7fffffff <code><pre>
  ...
  /**
   * Result of long m0x40001 <code><pre>
  ...
  /**
   * Result of long -0x80000000 <code><pre>
  ...
  /**
   * Result of long -0x80000001 <code><pre>
  ...
  /**
   * Result of double 127.0 <code><pre>
   * R x5d x7f
   * </pre></code>
   */
  ...
  /**
   * Result of double -128.0 <code><pre>
   * R x5d x80
   * </pre></code>
   */
  ...
  /**
   * Result of double -129.0 <code><pre>
   * R x5e xff x7f
   * </pre></code>
   */
  ...
  /**
   * Result of double 32767.0 <code><pre>
   * R x5e x7f xff
   * </pre></code>
   */
  ...
  /**
   * Result of double -32768.0 <code><pre>
   * R x5e x80 x80
   * </pre></code>
   */
  ...
  /**
   * Result of double 0.001 <code><pre>
  ...
  /**
   * Result of double 65.536 <code><pre>
  ...
  /**
   * Result of double 3.14159 <code><pre>
  ...
  /**
   * date 0 (01-01-1970 00:00 GMT) <code><pre>
   * x4a x00 x00 x00 x00
   * </pre></code>
   */
  ...
  /**
   * Date by millisecond (05-08-1998 07:51:31.000 GMT) <code><pre>
  ...
  /**
   * Date by minute (05-08-1998 07:51:00.000 GMT) <code><pre>
   * x4b x00 xe3 x83 x8f
   * </pre></code>
   */
  ...
  /**
   * A 65536-length string <code><pre>
   * R x80 x00 000 ...
   * S x04 x00 000 01234567890123456789012345678901...
   * </pre></code>
   */
  ...
  /**
   * A 65536-length binary <code><pre>
   * A x80 x00 000 ...
   * B x04 x00 000 01234567890123456789012345678901...
   * </pre></code>
   */
  ...
  /**
   * Zero-length untyped list <code><pre>
   * x78
   * </pre></code>
   */
  ...
  /**
   * 1-length untyped list <code><pre>
   * x79 x01 1
   * </pre></code>
   */
  ...
  /**
   * 7-length untyped list <code><pre>
  ...
  /**
   * 8-length untyped list <code><pre>
  ...
  /**
   * Zero-length typed list (String array) <code><pre>
   * x70 x07 [string
   * </pre></code>
   */
  ...
  /**
   * 1-length typed list (String array) <code><pre>
  ...
  /**
   * 7-length typed list (String array) <code><pre>
  ...
  /**
   * 8-length typed list (String array) <code><pre>
  ...
  /**
   * zero-length untyped map <code><pre>
   * H Z
   * </pre></code>
   */
  ...
  /**
   * untyped map with string key <code><pre>
   * H x01 a x90 Z
   * </pre></code>
   */
  ...
  /**
   * untyped map with int key <code><pre>
  ...
  /**
   * untyped map with list key <code><pre>
   * H x71 x01 a x90 Z
   * </pre></code>
   */
  ...
  /**
   * zero-length typed map <code><pre>
  ...
  /**
   * typed map with int key <code><pre>
  ...
  /**
   * typed map with list key <code><pre>
  ...
  /**
   * Returns a single object <code><pre>
  ...
  /**
   * Simple object with one field <code><pre>
  ...
  /**
   * Simple two objects with one field <code><pre>
   * x7a
  ...
  /**
   * Simple repeated object <code><pre>
   * x7a
   *   C x22 com.caucho.hessian.test.TestObject x91 x06 _value
   *   x60 x90
   *   Q x91
  ...
  /**
   * Two object with equals <code><pre>
   * x7a
   *   C x22 com.caucho.hessian.test.TestObject x91 x06 _value
   *   x60 x90
   *   x60 x90
  ...
  /**
   * Date by millisecond (05-08-1998 07:51 GMT) <code><pre>
   * x4a x00 x00 x00 xd0 x4b x92 x84 xb8
   * </pre></code>
   */
  ...
  /**
   * Date by minute (05-08-1998 07:51 GMT) <code><pre>
   * x4b x00 xe3 x83 x8f
   * </pre></code>
   */
