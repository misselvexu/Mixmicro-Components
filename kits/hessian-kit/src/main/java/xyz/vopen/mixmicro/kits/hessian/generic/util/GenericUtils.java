 ...
 */
package xyz.vopen.mixmicro.kits.hessian.generic.util;

import sun.misc.Unsafe;
import xyz.vopen.mixmicro.kits.hessian.generic.exception.ConvertException;
...
import xyz.vopen.mixmicro.kits.hessian.generic.model.*;
...
import static xyz.vopen.mixmicro.kits.hessian.generic.io.GenericDeserializer.ARRAY_PREFIX;
...
public class GenericUtils {
  ...
  private static final CopyOnWriteArrayList<CustomConverter> HANDLERS =
      new CopyOnWriteArrayList<CustomConverter>();
  ...
  private static Object doConvertToObject(GenericObject genericObject, Map<Object, Object> map)
    ...
    if (Enum.class.isAssignableFrom(clazz)) {
      Method valueOfMethod = clazz.getMethod("valueOf", new Class[] {Class.class, String.class});
  ...
  private static Object doConvertToCollection(
      GenericCollection genericCollection, Map<Object, Object> map) throws Exception {
  ...
  private static Object doConvertToMap(GenericMap genericMap, Map<Object, Object> map)
    ...
    while (iter.hasNext()) {
      ...
      result.put(
          innerToConvertObject(entry.getKey(), map), innerToConvertObject(entry.getValue(), map));
    }
  ...
  private static Object doConvertToGenericCollection(Collection collection, Map<Object, Object> map)
      throws Exception {
  ...
  private static Object doConvertToGenericMap(Map valueMap, Map<Object, Object> map)
    ...
    while (iter.hasNext()) {
      Map.Entry entry = (Map.Entry) iter.next();
      defaultMap.put(
          innerConvertToGenericObject(entry.getKey(), map),
  ...
  private static Object doConvertToGenericArray(Object array, Map<Object, Object> map)
    ...
    GenericArray genericArray =
        new GenericArray(convertHessianFormat(clazz.getComponentType().getName()));
  ...
  private static Object instantiate(Class clazz) throws Exception {
    ...
    try {
      ...
      if (constructor != null) return constructor.newInstance(constructorArgs);
  ...
  /**
   * 对于Object[]数组, hessian传入的componentType为[java.lang.Object, 但是Class.forName 需要的字符串是
   * [Ljava.lang.Object; 这里为了实现兼容, 需要把 [Ljava.lang.Object 转为 [java.lang.Object
   *
   * @return
   */
