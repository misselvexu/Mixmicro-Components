...
public class GenericSerializerFactory extends SerializerFactory {
  ...
  private static final ConcurrentMap<String, Deserializer> deserializerMap =
      new ConcurrentHashMap<String, Deserializer>();

  private static final char ARRAY_PREFIX = '[';

  private List<AbstractGenericSerializerFactory> factories =
      new CopyOnWriteArrayList<AbstractGenericSerializerFactory>();
