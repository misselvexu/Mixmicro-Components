...
import xyz.vopen.mixmicro.components.logger.core.spi.LogbackReInitializer;
...
public class LogbackLoggerSpaceFactory extends AbstractLoggerSpaceFactory {
   ...
   * @param source
   */
  public LogbackLoggerSpaceFactory(
      SpaceId spaceId,
    ...
    Iterator<LogbackFilterGenerator> matchers =
        ServiceLoader.load(LogbackFilterGenerator.class, this.getClass().getClassLoader())
            .iterator();
  ...
  public Logger setLevel(String loggerName, AdapterLevel adapterLevel) throws Exception {
    ch.qos.logback.classic.Logger logbackLogger =
        (ch.qos.logback.classic.Logger) this.getLogger(loggerName);
  ...
  public void reInitialize(Map<String, String> environment) {
    ...
    Iterator<LogbackReInitializer> matchers =
        ServiceLoader.load(LogbackReInitializer.class, this.getClass().getClassLoader()).iterator();
    if (matchers.hasNext()) {
