 ...
 * <p>
 *
 * @author <a href="mailto:iskp.me@gmail.com">Elve.Xu</a> on 16/9/20.
 */
public final class LogEnvUtils {
  ...
  /**
   * * slf4j-jcl commons-logger
   *
   * <p>默认使用 log4j 作为初始化实现
   *
  ...
  /** 对通用的全局日志相关的配置变量进行整理 logging.path loggingRoot file.encoding PID */
   ...
   * logging.path loggingRoot file.encoding
   */
  ...
  public static boolean filterAllLogConfig(String key) {
    return key.startsWith(MIXMICRO_CONFIG_PREFIX)
