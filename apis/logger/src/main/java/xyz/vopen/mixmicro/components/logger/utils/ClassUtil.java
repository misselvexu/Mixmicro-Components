...
public class ClassUtil {
  ...
  public static Class getArrayClass(Class componentType, int dimension) {
    return dimension <= 0
        ...
        : (componentType == null
            ? null
            : Array.newInstance(componentType, new int[dimension]).getClass());
  }
    ...
    private TypeInfo(Class type) {
      ...
      if (this.dimension > 0) {
        ...
        if (superComponentType != null) {
          componentInterface = ClassUtil.getArrayClass(superComponentType, this.dimension);
        ...
        if (superComponentType != null) {
          ...
          this.superclasses.addAll(ClassUtil.getTypeInfo(superComponentType).superclasses);
        }
      }
