 ...
 * <p>
 *
 * @author <a href="mailto:iskp.me@gmail.com">Elve.Xu</a> on 17/01/17.
 */
    ...
    try {
      ...
      return new AbstractLoggerSpaceFactory(getLoggingToolName()) {
        ...
        ConcurrentMap<String, JCLLoggerAdapter> loggerMap =
            new ConcurrentHashMap<String, JCLLoggerAdapter>();
        ...
        private JCLLoggerAdapter createCommonsLoggingLoggerAdapter2Slf4j(String name) {
          ...
          try {
            org.apache.commons.logging.impl.Log4JLogger log4jLogger =
                new org.apache.commons.logging.impl.Log4JLogger(log4j);

            Constructor<JCLLoggerAdapter> constructor =
                JCLLoggerAdapter.class.getDeclaredConstructor(
                    org.apache.commons.logging.Log.class, String.class);
