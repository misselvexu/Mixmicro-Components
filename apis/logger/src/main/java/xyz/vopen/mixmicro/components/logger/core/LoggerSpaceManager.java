 ...
 *
 * <p>请使用 @Link(MultiAppLoggerSpaceManager.class)
 *
 * @author <a href="mailto:iskp.me@gmail.com">Elve.Xu</a> on 16/9/12. Updated by
...
public class LoggerSpaceManager {
  ...
  public static Logger getLoggerBySpace(String name, String spaceName) {
    return getLoggerBySpace(name, new SpaceId(spaceName), Collections.<String, String>emptyMap());
  }
  ...
  public static Logger getLoggerBySpace(
      String name, SpaceId spaceId, Map<String, String> properties) {
    // init first
  ...
  public static Logger getLoggerBySpace(
    ...
    return getLoggerBySpace(
        name, new SpaceId(spaceName), Collections.<String, String>emptyMap(), spaceClassloader);
  }
   ...
   */
  public static Logger getLoggerBySpace(
      String name, SpaceId spaceId, Map<String, String> properties, ClassLoader spaceClassloader) {
    // init first
    init(spaceId, properties);
   ...
   * @return
   *     更新级别后的日志,与xyz.vopen.mixmicro.components.common.core.MultiAppLoggerSpaceManager#getLoggerBySpace(java.lang.String,
