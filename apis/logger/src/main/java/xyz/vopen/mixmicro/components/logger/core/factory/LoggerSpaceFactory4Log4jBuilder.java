    ...
    try {
      ...
      return new AbstractLoggerSpaceFactory(getLoggingToolName()) {
        ...
        ConcurrentMap<String, Log4jLoggerAdapter> loggerMap =
            new ConcurrentHashMap<String, Log4jLoggerAdapter>();
        ...
        private org.apache.log4j.Level toLog4jLevel(AdapterLevel adapterLevel) {
          ...
          switch (adapterLevel) {
            ...
            default:
              throw new IllegalStateException(adapterLevel + " is unknown when adapter to log4j.");
          }
        }
        ...
        private Log4jLoggerAdapter createSlf4jLogger(String name) {
          ...
          // 反射实例化
          try {
            Constructor<Log4jLoggerAdapter> constructor =
