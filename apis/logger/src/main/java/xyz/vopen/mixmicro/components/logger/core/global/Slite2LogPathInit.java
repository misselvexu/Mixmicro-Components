 ...
 */
package xyz.vopen.mixmicro.components.logger.core.global;
 ...
 * <p>
 *
 * @author <a href="mailto:iskp.me@gmail.com">Elve.Xu</a> on 16/11/3.
 */
public class Slite2LogPathInit {
   ...
   *
   * <p>1.是否设置了全局路径参数 logging.path 2.没有设置将设置路径 middlewareLoggingPath
   *
  ...
  public static void initLoggingPath(String middlewareLoggingPath) {
    if (isBlank((String) System.getProperties().get(Constants.LOG_PATH))
      ...
      ReportUtil.reportDebug(
          "Actual " + Constants.LOG_PATH + " is [ " + middlewareLoggingPath + " ]");
    }
  }
