 ...
 */
package xyz.vopen.mixmicro.components.logger.profile.diagnostic;

import xyz.vopen.mixmicro.components.logger.profile.enumeration.IntegerEnum;
import xyz.vopen.mixmicro.components.logger.utils.ObjectUtil;
