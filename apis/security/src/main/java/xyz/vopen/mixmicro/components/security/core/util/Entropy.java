...
public class Entropy {
   ...
   *
   * <p>The returned value is a value between <code>0</code> and <code>1</code> where a value of
   * <code>0</code> signifies no entropy and a value of <code>1</code> maximum entropy.
   *
   * <p>This method may be used to assess the entropy of randomly generated key material but is in
   * no way by itself a reliable indicator of true randomness.
   *
   * <p>It indicates distribution entropy as opposed to sequence entropy.
   *
   * @param bytes
   * @return
   */
