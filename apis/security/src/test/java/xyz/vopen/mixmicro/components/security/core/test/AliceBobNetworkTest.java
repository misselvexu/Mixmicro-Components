...
/**
 * Unit test that performs a key agreement with a server over a TCP socket and sends a file to the
 * server encrypted using the agreed shared secret.
 *
...
public class AliceBobNetworkTest {
  ...
  /**
   * Runnable that represents the server named Bob that receives the file.
   *
   * @author <a href="mailto:iskp.me@gmail.com">Elve.Xu</a>
   */
