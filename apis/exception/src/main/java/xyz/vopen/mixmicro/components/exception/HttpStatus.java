...
public enum HttpStatus {
  ...
  /**
   * Whether this status code is in the HTTP series {@link HttpStatus.Series#INFORMATIONAL}. This is
  ...
  /**
   * Whether this status code is in the HTTP series {@link HttpStatus.Series#SUCCESSFUL}. This is a
  ...
  /**
   * Whether this status code is in the HTTP series {@link HttpStatus.Series#REDIRECTION}. This is a
   * shortcut for checking the value of {@link #series()}.
   *
   * @since 4.0
   * @see #series()
  ...
  /**
   * Whether this status code is in the HTTP series {@link HttpStatus.Series#CLIENT_ERROR}. This is
   * a shortcut for checking the value of {@link #series()}.
   *
   * @since 4.0
   * @see #series()
  ...
  /**
   * Whether this status code is in the HTTP series {@link HttpStatus.Series#SERVER_ERROR}. This is
   * a shortcut for checking the value of {@link #series()}.
   *
   * @since 4.0
   * @see #series()
  ...
  /**
   * Whether this status code is in the HTTP series {@link HttpStatus.Series#CLIENT_ERROR} or {@link
   * HttpStatus.Series#SERVER_ERROR}. This is a shortcut for checking the value of {@link
   * #series()}.
   *
   * @since 5.0
