...
/**
 * {@link MixmicroCircuitBreakerException}
 *
...
public class MixmicroCircuitBreakerException extends RuntimeException {
   ...
   */
  public MixmicroCircuitBreakerException() {}
   ...
   */
  public MixmicroCircuitBreakerException(String message) {
    super(message);
  }
   ...
   * @since 1.4
   */
  public MixmicroCircuitBreakerException(String message, Throwable cause) {
    super(message, cause);
  }
   ...
   * @since 1.4
   */
  public MixmicroCircuitBreakerException(Throwable cause) {
    super(cause);
  }
}
