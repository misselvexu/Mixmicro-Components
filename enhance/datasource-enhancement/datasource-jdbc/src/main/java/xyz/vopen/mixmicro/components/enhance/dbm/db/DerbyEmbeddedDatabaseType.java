...
/**
 * Derby database type information used to create the tables, etc.. This is for an embedded Derby
 * database. For client connections to a remote Derby server, you should use {@link
...
public class DerbyEmbeddedDatabaseType extends BaseDatabaseType {
  ...
  /**
   * Conversion from the Object Java field to the BLOB Jdbc type because the varbinary needs a size
   * otherwise.
   */
