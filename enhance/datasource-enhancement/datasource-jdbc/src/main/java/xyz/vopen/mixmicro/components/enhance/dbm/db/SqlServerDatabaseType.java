 ...
 *
 * <p><b>WARNING:</b> I have not tested this unfortunately because of a lack of permanent access to
 * a MSSQL instance.
 *
...
public class SqlServerDatabaseType extends BaseDatabaseType {
  ...
  /**
   * Conversion from the byte Java field to the SMALLINT Jdbc type because TINYINT looks to be 0-255
   * and unsigned.
   */
