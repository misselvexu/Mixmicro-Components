...
import xyz.vopen.mixmicro.components.enhance.dbm.field.BaseFieldConverter;
 ...
 *
 * <p>Here's a good page about the <a href="http://docs.codehaus.org/display/CASTOR/Type+Mapping"
 * >mapping for a number of database types</a>:
 *
 * <p><b>NOTE:</b> If you are creating your own custom database persister, you probably will need to
 * override the {@link BaseFieldConverter#sqlArgToJava(FieldType, Object, int)} method as well which
 * converts from a SQL data to java.
 *
...
public abstract class BaseDataType extends BaseFieldConverter implements DataPersister {
  ...
  /**
   * Type of the data as it is persisted in SQL-land. For example, if you are storing a DateTime,
   * you might consider this to be a {@link SqlType#LONG} if you are storing it as epoche
   * milliseconds.
   */
   ...
   * @param classes Associated classes for this type. These should be specified if you want this
   *     type to be always used for these Java classes. If this is a custom persister then this
