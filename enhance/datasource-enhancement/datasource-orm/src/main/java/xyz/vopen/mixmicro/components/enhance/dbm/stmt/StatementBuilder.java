...
public abstract class StatementBuilder<T, ID> {
  ...
  public StatementBuilder(
      DatabaseType databaseType, TableInfo<T, ID> tableInfo, Repository<T, ID> repository, StatementType type) {
    ...
    if (!type.isOkForStatementBuilder()) {
      throw new IllegalStateException(
          "Building a statement from a " + type + " statement is not allowed");
    }
  }

  /**
   * Creates and returns a new {@link Where} object for this QueryBulder that can be used to add
   * WHERE clauses to the SQL statement. Only one {@link Where} object can be associated with a
   * QueryBuilder at a time and calling this method again creates a new {@link Where} object and
   * resets the where information for this QueryBuilder.
   */
  ...
  /**
   * Set the {@link Where} object on the query. This allows someone to use the same Where object on
   * multiple queries.
   */
   ...
   */
  protected MappedPreparedStmt<T, ID> prepareStatement(Long limit, boolean cacheStore)
      throws SQLException {
    ...
    return new MappedPreparedStmt<T, ID>(
        repository,
        tableInfo,
        statement,
        argFieldTypes,
  ...
  /**
   * Build and return a string version of the query. If you change the where or make other calls you
   * will need to re-call this method to re-prepare the query for execution.
   */
  ...
  /**
   * Build and return all of the information about the prepared statement. See {@link StatementInfo}
   * for more details.
   */
  ...
  /**
   * Internal method to build a query while tracking various arguments. Users should use the {@link
   * #prepareStatementString()} method instead.
   *
   * <p>This needs to be protected because of (WARNING: DO NOT MAKE A JAVADOC LINK)
   * InternalQueryBuilder (WARNING: DO NOT MAKE A JAVADOC LINK).
   */
  ...
  /**
   * Get the result array from our statement after the {@link #appendStatementStart(StringBuilder,
   * List)} was called. This will be null except for the QueryBuilder.
   */
  ...
  public static enum StatementType {
    ...
    /**
     * SQL statement in the form of CREATE TABLE, ALTER TABLE, or something returning the number of
     * rows affected
     */
  ...
  /**
   * Class which wraps information about a statement including the arguments and the generated SQL
   * statement string.
   */
