...
public interface Log {
  ...
  ;
    ...
    /**
     * Return whether or not a level argument is enabled for this level value. So, {@code
     * Level.INFO.isEnabled(Level.WARN)} returns true but {@code Level.INFO.isEnabled(Level.DEBUG)}
     * returns false.
     */
