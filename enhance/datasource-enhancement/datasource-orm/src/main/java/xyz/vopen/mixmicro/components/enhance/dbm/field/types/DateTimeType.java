...
/**
 * A custom persister that is able to store the org.joda.time.DateTime class in the database as
 * epoch-millis long integer. This is done with reflection so we don't have to introduce the
 * dependency.
 *
 * <p><b>NOTE:</b> Because this class uses reflection, you have to specify this using {@link
