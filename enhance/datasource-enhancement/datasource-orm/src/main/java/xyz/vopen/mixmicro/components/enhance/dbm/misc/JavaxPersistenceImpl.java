...
import xyz.vopen.mixmicro.components.enhance.dbm.field.DataPersisterManager;
...
/**
 * Class for isolating the detection of the javax.persistence annotations. This used to be a hard
 * dependency but it has become optinal/test since we use reflection here.
 *
...
public class JavaxPersistenceImpl implements JavaxPersistenceConfigurer {
  ...
  public DatabaseFieldConfig createFieldConfig(DatabaseType databaseType, Field field) {
    ...
    config.setUseGetSet(
        DatabaseFieldConfig.findGetMethod(field, databaseType, false) != null
