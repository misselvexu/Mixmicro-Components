...
/**
 * Booleans can be stored in the database as the integer column type and the value 1 (really non-0)
 * for true and 0 for false. You must choose this DataType specifically with the {@link
