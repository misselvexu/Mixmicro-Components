...
public abstract class BaseConnectionSource implements ConnectionSource {
  ...
  /**
   * Save this connection as our special connection to be returned by the {@link
      ...
      if (currentSaved.connection != connection) {
        throw new SQLException(
            "trying to save connection "
                + connection
                + " but already have saved connection "
  ...
  protected boolean isSingleConnection(DatabaseConnection conn1, DatabaseConnection conn2)
      throws SQLException {
