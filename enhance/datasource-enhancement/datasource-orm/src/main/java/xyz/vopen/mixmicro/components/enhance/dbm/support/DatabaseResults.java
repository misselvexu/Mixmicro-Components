 ...
 *
 * <p><b>NOTE:</b> In all cases, the columnIndex parameters are 0 based -- <i>not</i> 1 based like
 * JDBC.
 *
...
public interface DatabaseResults extends Closeable {
  ...
  /**
   * Moves to the first result. This may not work with the default iterator depending on your
   * database.
   *
  ...
  /**
   * Moves to the previous result. This may not work with the default iterator depending on your
   * database.
   *
   * @return true if there are more results to be processed.
   */
  ...
  /**
   * Moves to the last result. This may not work with the default iterator depending on your
   * database.
   *
   * @return true if there are more results to be processed.
   */
   ...
   * moveRelative(1) should be the same as {@link #next()}. moveRelative(-1) is the same as {@link
   * #previous} result. This may not work with the default iterator depending on your database.
   *
  ...
  /**
   * Moves to an absolute position in the list of results. This may not work with the default
