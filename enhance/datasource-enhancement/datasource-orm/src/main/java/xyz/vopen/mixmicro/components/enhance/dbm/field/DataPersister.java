...
import xyz.vopen.mixmicro.components.enhance.dbm.field.types.BaseDataType;
 ...
 *
 * <p>If you are defining your own custom persister, then chances are you should extend {@link
 * BaseDataType}. See {@link DatabaseField#persisterClass()}.
 *
...
public interface DataPersister extends FieldConverter {
  ...
  /**
   * Return the class names that should be associated with this or null. This is used by reflection
   * classes so we can discover if a Field matches _without_ needed the class dependency in -core.
   */
  public String[] getAssociatedClassNames();

  /**
   * Convert a {@link Number} object to its primitive object suitable for assigning to a java ID
   * field.
   */
  public Object convertIdNumber(Number number);

  /**
   * Return true if this type can be auto-generated by the database. Probably only numbers will
   * return true.
   */
  ...
  /**
   * Return whether we need to escape this value in SQL expressions. Numbers _must_ not be escaped
   * but most other values should be.
   */
  public boolean isEscapedValue();

  /**
   * Return whether this field is a primitive type or not. This is used to know if we should throw
