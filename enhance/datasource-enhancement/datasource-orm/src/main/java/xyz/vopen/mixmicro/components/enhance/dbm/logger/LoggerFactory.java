...
import xyz.vopen.mixmicro.components.enhance.dbm.logger.Log.Level;

import java.lang.reflect.Constructor;

/**
 * Factory that creates {@link Logger} instances. It uses reflection to see what loggers are
...
public class LoggerFactory {
  ...
  public enum LogType {
    /** Slf4j */
    SLF4J("org.slf4j.LoggerFactory", "Slf4jLoggingLog"),
    /**
    ...
    JAVA_UTIL("java.util.logging.Logger", "JavaUtilLog"),
  // end
  ;
    ...
    public Log createLog(String classLabel) {
      try {
        ...
        log.log(
            Level.WARNING,
            "Unable to call constructor with single String argument for class "
                + logClassName
                + ", so had to use local log: "
                + e.getMessage());
        return log;
      }
    }
    ...
    /**
     * Is this class available meaning that we should use this logger. This is package permissions
