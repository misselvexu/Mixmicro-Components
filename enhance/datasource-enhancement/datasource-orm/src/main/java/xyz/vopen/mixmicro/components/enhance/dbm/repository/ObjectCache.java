...
/**
 * Definition of an object cache that can be injected into the Repository with the {@link
 * Repository#setObjectCache(ObjectCache)}.
 *
 * <p><b>NOTE:</b> Most of the below methods take a Class argument but your cache can be for a
 * single cache. If this is the case then you should protect against storing different classes in
 * the cache.
 *
...
public interface ObjectCache {
  ...
  /**
   * Register a class for use with this class. This will be called before any other method for the
