...
/**
 * Database connection proxy factory that uses reflection to create the proxied connection. The
 * class in question should have a constructor that takes a {@link DatabaseConnection} object.
 *
...
public class ReflectionDatabaseConnectionProxyFactory implements DatabaseConnectionProxyFactory {
  ...
  /**
   * Takes a proxy-class that will be used to instantiate an instance in {@link
   * #createProxy(DatabaseConnection)}.
   *
   * @throws IllegalArgumentException if the class does not have a constructor that takes a {@link
