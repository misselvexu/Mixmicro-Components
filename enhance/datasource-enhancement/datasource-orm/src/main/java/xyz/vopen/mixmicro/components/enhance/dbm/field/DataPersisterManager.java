...
import xyz.vopen.mixmicro.components.enhance.dbm.field.types.EnumStringType;
...
/**
 * Class used to manage the various data types used by the system. The bulk of the data types come
 * from the {@link DataType} enumerated fields although you can also register your own here using
 * the {@link #registerDataPersisters(DataPersister...)} method.
 *
...
public class DataPersisterManager {
  ...
  /**
   * Remove any previously persisters that were registered with {@link
