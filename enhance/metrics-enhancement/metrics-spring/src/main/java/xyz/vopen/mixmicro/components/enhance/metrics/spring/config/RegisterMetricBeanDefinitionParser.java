 ...
 */
package xyz.vopen.mixmicro.components.enhance.metrics.spring.config;
...
class RegisterMetricBeanDefinitionParser implements BeanDefinitionParser {
	...
	public BeanDefinition parse(Element element, ParserContext parserContext) {
		...
		for (Element metricElement : metricElements) {
			...
			final String name = metricElement.getAttributeNS(MetricsNamespaceHandler.METRICS_NAMESPACE, "name");
			if (name != null) {
				metricElement.removeAttributeNS(MetricsNamespaceHandler.METRICS_NAMESPACE, "name");
			}
