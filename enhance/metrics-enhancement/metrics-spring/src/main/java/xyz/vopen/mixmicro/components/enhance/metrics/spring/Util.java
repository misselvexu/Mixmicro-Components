...
class Util {
	...
	@Deprecated
	static String forCachedGauge(Class<?> klass, Member member, xyz.vopen.mixmicro.components.enhance.metrics.annotation.CachedGauge annotation) {
		return chooseName(annotation.name(), annotation.absolute(), klass, member);
	}

	@Deprecated
	static String forCountedMethod(Class<?> klass, Member member, xyz.vopen.mixmicro.components.enhance.metrics.annotation.Counted annotation) {
		return chooseName(annotation.name(), annotation.absolute(), klass, member);
	}

	@Deprecated
	static String forMetricField(Class<?> klass, Member member, xyz.vopen.mixmicro.components.enhance.metrics.annotation.Metric annotation) {
		return chooseName(annotation.name(), annotation.absolute(), klass, member);
	}
