...
public class EnableMixmicroMetricsTest {
	...
	public void gaugeField() throws Throwable {
		...
		Gauge<Integer> fieldGauge = (Gauge<Integer>) TestUtil.forGaugeField(metricRegistry, TestBean.class, "intGaugeField");
	...
	public void gaugeMethod() throws Throwable {
		...
		Gauge<Integer> methodGauge = (Gauge<Integer>) TestUtil.forGaugeMethod(metricRegistry, TestBean.class, "intGaugeMethod");
	...
	public void cachedGaugeMethod() throws Throwable {
		// Verify that the Gauge method's value is returned
		CachedGauge<Integer> methodCachedGauge = (CachedGauge<Integer>) TestUtil.forCachedGaugeMethod(metricRegistry, TestBean.class, "cachedGaugeMethod");
	...
	public void timedMethod() throws Throwable {
		...
		Timer timedMethodTimer = TestUtil.forTimedMethod(metricRegistry, TestBean.class, "timedMethod");
	...
	public void meteredMethod() throws Throwable {
		...
		Meter meteredMethodMeter = TestUtil.forMeteredMethod(metricRegistry, TestBean.class, "meteredMethod");
	...
	public void countedMethod() throws Throwable {
		// Verify that the Meter's counter is incremented on method invocation
		final Counter countedMethodMeter = TestUtil.forCountedMethod(metricRegistry, TestBean.class, "countedMethod");
	...
	public void exceptionMeteredMethod() throws Throwable {
		// Verify that the Meter's counter is incremented on method invocation
		Meter exceptionMeteredMethodMeter = TestUtil.forExceptionMeteredMethod(metricRegistry, TestBean.class, "exceptionMeteredMethod");
