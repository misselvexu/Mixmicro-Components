...
public class MeteredClassImpementsInterfaceTest {
	...
	public void timedMethod() throws Throwable {
		Timer timedMethod = TestUtil.forTimedMethod(metricRegistry, MeteredClassImpl.class, "timedMethod");
	...
	public void meteredMethod() throws Throwable {
		Meter meteredMethod = TestUtil.forMeteredMethod(metricRegistry, MeteredClassImpl.class, "meteredMethod");
	...
	public void countedMethod() throws Throwable {
		final Counter countedMethod = TestUtil.forCountedMethod(metricRegistry, MeteredClassImpl.class, "countedMethod");
