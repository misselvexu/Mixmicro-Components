...
import static xyz.vopen.mixmicro.components.enhance.metrics.spring.TestUtil.forLegacyCountedMethod;
...
import xyz.vopen.mixmicro.components.enhance.metrics.annotation.Counted;
...
public class LegacyAnnotationMeteredClassTest {
	...
	@Test
	public void gauges() {
		CachedGauge<?> cachedGaugedMethod = TestUtil.forLegacyCachedGaugeMethod(metricRegistry, LegacyMeteredClass.class, "cachedGaugedMethod");
	...
	public void countedMethod() throws Throwable {
		final Counter countedMethod = TestUtil.forLegacyCountedMethod(metricRegistry, LegacyMeteredClass.class, "countedMethod");
	...
	public void monotonicCountedMethod() throws Throwable {
		final Counter countedMethod = TestUtil.forLegacyCountedMethod(metricRegistry, LegacyMeteredClass.class, "monotonicCountedMethod");
	...
	public void scopeTest() {
		Counter publicScopeMethodCounter = TestUtil.forLegacyCountedMethod(metricRegistry, LegacyMeteredClass.class, "publicScopeMethod");
		...
		Counter packageScopeMethodCounter = TestUtil.forLegacyCountedMethod(metricRegistry, LegacyMeteredClass.class, "packageScopeMethod");
		...
		Counter protectedScopeMethodCounter = TestUtil.forLegacyCountedMethod(metricRegistry, LegacyMeteredClass.class, "protectedScopeMethod");
		...
		Counter privateScopeMethodCounter = TestUtil.forLegacyCountedMethod(metricRegistry, LegacyMeteredClass.class, "privateScopeMethod");
	...
	public static class LegacyMeteredClass {
		...
		@xyz.vopen.mixmicro.components.enhance.metrics.annotation.CachedGauge(timeout = 1, timeoutUnit = TimeUnit.DAYS)
