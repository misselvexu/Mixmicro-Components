 ...
 */
public final class MixmicroClassKit {
  ...
  public static Class forName(String className, boolean initialize) {
    try {
      return Class.forName(className, initialize, MixmicroClassLoaders.getCurrentClassLoader());
    } catch (Exception e) {
   ...
   * @param <T> 对象具体类
   * @return 对象实例
   * @throws MixmicroSpiException 没有找到方法，或者无法处理，或者初始化方法异常等
   */
  public static <T> T newInstance(Class<T> clazz) throws MixmicroSpiException {
    ...
    try {
      ...
      if (constructors == null || constructors.length == 0) {
        throw new MixmicroSpiException(
    ...
    } catch (MixmicroSpiException e) {
      throw e;
    } catch (Throwable e) {
      throw new MixmicroSpiException(e.getMessage(), e);
    }
  }
