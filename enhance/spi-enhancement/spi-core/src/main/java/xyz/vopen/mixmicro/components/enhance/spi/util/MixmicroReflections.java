 ...
 * @version 1.2
 */
public class MixmicroReflections {
  ...
  public static Object invokeGetter(Object obj, String propertyName) {
    String getterMethodName = GETTER_PREFIX + MixmicroStrings.capitalize(propertyName);
    return invokeMethod(obj, getterMethodName, new Class[] {}, new Object[] {});
  }

  /** 调用Setter方法, 仅匹配方法名。 */
  public static void invokeSetter(Object obj, String propertyName, Object value) {
    String setterMethodName = SETTER_PREFIX + MixmicroStrings.capitalize(propertyName);
  ...
  public static Field getAccessibleField(final Object obj, final String fieldName) {
    MixmicroAssert.notNull(obj, "object can't be null");
    MixmicroAssert.isTrue(MixmicroStrings.hasText(fieldName), "fieldName can't be blank");
  ...
  public static Method getAccessibleMethod(
    ...
    MixmicroAssert.notNull(obj, "object can't be null");
    MixmicroAssert.isTrue(MixmicroStrings.hasText(methodName), "methodName can't be blank");
  ...
  public static Class<?> getUserClass(Object instance) {
    MixmicroAssert.notNull(instance, "Instance must not be null");
