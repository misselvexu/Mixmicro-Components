 ...
 */
public final class MixmicroStrings {

  public static final Charset UTF_8 = Charset.forName("UTF-8");
  private static final MixmicroStrings INSTANCE = new MixmicroStrings(); // for code coverage
  ...
  public static String[] concatenateStringArrays(String[] array1, String[] array2) {
    if (MixmicroObjects.isEmpty(array1)) {
      return array2;
    }
    if (MixmicroObjects.isEmpty(array2)) {
      return array1;
    }
  ...
  public static String arrayToDelimitedString(Object[] arr, String delim) {
    if (MixmicroObjects.isEmpty(arr)) {
      return "";
    }
    if (arr.length == 1) {
      return MixmicroObjects.nullSafeToString(arr[0]);
    }
    StringBuilder sb = new StringBuilder();
