 ...
 */
public final class MixmicroAssert {

  // for code coverage
  private static final MixmicroAssert INSTANCE = new MixmicroAssert();

  private MixmicroAssert() {}
   ...
   * @param message the exception message to use if the assertion fails
   * @see MixmicroStrings#hasLength
   */
  public static void hasLength(String text, String message) {
    if (!MixmicroStrings.hasLength(text)) {
      throw new IllegalArgumentException(message);
    }
  }
   ...
   * @param text the String to check
   * @param message the exception message to use if the assertion fails
   * @see MixmicroStrings#hasText
   */
  public static void hasText(String text, String message) {
    if (!MixmicroStrings.hasText(text)) {
      throw new IllegalArgumentException(message);
    }
  }
  ...
  public static void doesNotContain(String textToSearch, String substring, String message) {
    if (MixmicroStrings.hasLength(textToSearch)
        && MixmicroStrings.hasLength(substring)
  ...
  public static void notEmpty(Object[] array, String message) {
    if (MixmicroObjects.isEmpty(array)) {
      throw new IllegalArgumentException(message);
    }
  }
