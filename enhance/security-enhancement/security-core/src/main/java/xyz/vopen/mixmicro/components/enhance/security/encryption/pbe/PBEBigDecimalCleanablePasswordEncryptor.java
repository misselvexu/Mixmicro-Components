 ...
 * a BigDecimal result, and provide means to set passwords as <i>cleanable</i> char[] objects
 * (instead of immutable Strings).
 *
 ...
 *
 * <p>For a default implementation, see {@link StandardPBEBigDecimalEncryptor}.
 *
 * @since 1.8
