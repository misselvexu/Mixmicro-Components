 ...
 * =============================================================================
 */
package xyz.vopen.mixmicro.components.enhance.security.commons;
...
/**
 * Common utils regarding treatment of parameter values and encoding operations. <b>This class is
...
public final class CommonUtils {
  ...
  private static final List STRING_OUTPUT_TYPE_HEXADECIMAL_NAMES =
      Arrays.asList(new String[] {"HEXADECIMAL", "HEXA", "0X", "HEX", "HEXADEC"});
