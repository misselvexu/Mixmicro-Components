...
/**
 * Pooled implementation of {@link PBEBigDecimalEncryptor} that in fact contains an array of {@link
 * StandardPBEBigDecimalEncryptor} objects which are used to attend encrypt and decrypt requests in
 * round-robin. This should result in higher performance in multiprocessor systems.
 *
 * <p>Configuration of this class is equivalent to that of {@link StandardPBEBigDecimalEncryptor}.
 *
