...
/**
 * Implementation for {@link DigesterConfig} which can retrieve configuration values from
 * environment variables or system properties.
 *
 * <p>The name of the environment variable or system property (JVM property) to query for each
 * parameter can be set with its corresponding <tt>setXEnvName</tt> or <tt>setXSysProperty</tt>
 * method.
 *
 * <p>As this class extends {@link SimpleDigesterConfig}, parameter values can be also set with the
 * usual <tt>setX</tt> methods.
 *
 * <p>For any of the configuration parameters, if its value is not configured in any way, a
...
public class EnvironmentDigesterConfig extends SimpleDigesterConfig {
  ...
  /**
   * Set the config object to use the specified environment variable to load the value for the
   * algorithm.
   *
  ...
  /**
   * Set the config object to use the specified JVM system property to load the value for the
   * algorithm.
   *
  ...
  /**
   * Retrieve the name of the environment variable which value has been loaded as the iteration
   * count.
   *
   * @return the name of the variable
   */
  ...
  /**
   * Retrieve the name of the JVM system property which value has been loaded as the iteration
   * count.
   *
   * @return the name of the property
   */
  ...
  /**
   * Retrieve the name of the environment variable which value has been loaded as the salt size in
   * bytes.
   *
   * @return the name of the variable
   */
  ...
  /**
   * Set the config object to use the specified environment variable to load the value for the salt
   * size in bytes.
   *
  ...
  /**
   * Retrieve the name of the JVM system property which value has been loaded as the salt size in
   * bytes.
   *
   * @return the name of the property
   */
  ...
  /**
   * Set the config object to use the specified JVM system property to load the value for the salt
   * size in bytes.
   *
  ...
  /**
   * Retrieve the name of the environment variable which value has been loaded as the salt generator
   * class name.
   *
   * @since 1.3
   * @return the name of the variable
   ...
   *
   * <p>The salt generator class name which is set here must have a no-argument constructor, so that
   * it can be instantiated and passed to the digester.
   *
   * @since 1.3
  ...
  /**
   * Retrieve the name of the JVM system property which value has been loaded as the salt generator
   * class name.
   *
   * @since 1.3
   * @return the name of the property
  ...
  /**
   * Retrieve the name of the environment variable which value has been loaded as the provider class
   * name.
   *
   * @since 1.3
   * @return the name of the variable
   ...
   * provider class name.
   *
   * <p>The provider class name which is set here must have a no-argument constructor, so that it
   * can be instantiated and passed to the digester.
   *
   * @since 1.3
  ...
  /**
   * Retrieve the name of the JVM system property which value has been loaded as the provider class
   * name.
   *
   * @since 1.3
   * @return the name of the property
  ...
  /**
   * Retrieve the name of the environment variable which value has been loaded as the value for the
   * invertPositionOfSaltInMessageBeforeDigesting property.
   *
   * @since 1.7
   * @return the name of the variable
   */
  ...
  /**
   * Retrieve the name of the JVM system property which value has been loaded as the value for the
   * invertPositionOfSaltInMessageBeforeDigesting property.
   *
   * @since 1.7
   * @return the name of the property
   ...
   */
  public void setInvertPositionOfSaltInMessageBeforeDigestingSysPropertyName(
      final String invertPositionOfSaltInMessageBeforeDigestingSysPropertyName) {
    this.invertPositionOfSaltInMessageBeforeDigestingSysPropertyName =
  ...
  /**
   * Retrieve the name of the environment variable which value has been loaded as the value for the
   * invertPositionOfPlainSaltInEncryptionResults property.
   *
   * @since 1.7
   * @return the name of the variable
   */
   ...
   */
  public void setInvertPositionOfPlainSaltInEncryptionResultsEnvName(
      final String invertPositionOfPlainSaltInEncryptionResultsEnvName) {
    this.invertPositionOfPlainSaltInEncryptionResultsEnvName =
   ...
   */
  public void setInvertPositionOfPlainSaltInEncryptionResultsSysPropertyName(
      final String invertPositionOfPlainSaltInEncryptionResultsSysPropertyName) {
    this.invertPositionOfPlainSaltInEncryptionResultsSysPropertyName =
  ...
  /**
   * Retrieve the name of the environment variable which value has been loaded as the value for the
   * useLenientSaltSizeCheck property.
   *
   * @since 1.7
   * @return the name of the variable
   */
  ...
  public void setUseLenientSaltSizeCheckEnvName(final String useLenientSaltSizeCheckEnvName) {
    ...
    if (useLenientSaltSizeCheckEnvName == null) {
      ...
      super.setUseLenientSaltSizeCheck(
          CommonUtils.getStandardBooleanValue(System.getenv(useLenientSaltSizeCheckEnvName)));
    }
  }
   ...
   */
  public void setUseLenientSaltSizeCheckSysPropertyName(
