...
/**
 * Pooled implementation of {@link StringDigester} that in fact contains an array of {@link
 * StandardStringDigester} objects which are used to attend digest and match requests in
 * round-robin. This should result in higher performance in multiprocessor systems.
 *
 * <p>Configuration of this class is equivalent to that of {@link StandardStringDigester}.
 *
...
public class PooledStringDigester implements StringDigester {
  ...
  public synchronized void setInvertPositionOfSaltInMessageBeforeDigesting(
    ...
    this.firstDigester.setInvertPositionOfSaltInMessageBeforeDigesting(
  ...
  public synchronized void setInvertPositionOfPlainSaltInEncryptionResults(
    ...
    this.firstDigester.setInvertPositionOfPlainSaltInEncryptionResults(
