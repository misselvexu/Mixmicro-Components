 ...
 * =============================================================================
 */
package xyz.vopen.mixmicro.components.enhance.security.intf.service;
...
import xyz.vopen.mixmicro.components.enhance.security.digest.config.EnvironmentStringDigesterConfig;
import xyz.vopen.mixmicro.components.enhance.security.encryption.pbe.StandardPBEStringEncryptor;
import xyz.vopen.mixmicro.components.enhance.security.encryption.pbe.config.EnvironmentStringPBEConfig;
import xyz.vopen.mixmicro.components.enhance.security.exceptions.EncryptionOperationNotPossibleException;

/**
 * This class acts as a stateless service for encryption, decryption and digest operations, letting
 * its clients configure all the security environment (algorithms, passwords, providers,
 * initialization vectors...) from Strings in a single call, be it using direct values, environment
 * variables or java vm properties.
 *
 * <p>It is meant to service the CLI interfaces, but it can also be used for other purposes. For
 * instance, by subclassing or wrapping it with a JAX-WS web service class, developers can easily
 * create an encryption web service.
 *
 * @since 1.4
 * @author <a href="mailto:iskp.me@gmail.com">Elve.Xu</a>
 */
public final class MixmicroSecurityStatelessService {

  /** Creates a new instance of <tt>MixmicroSecurityStatelessService</tt>. */
  public MixmicroSecurityStatelessService() {
    super();
  }
   ...
   * @throws EncryptionOperationNotPossibleException if the operation could not be performed (either
   *     because of wrong input or wrong parametrization).
   */
  public String digest(
    ...
    if (invertPositionOfSaltInMessageBeforeDigestingEnvName != null) {
      config.setInvertPositionOfSaltInMessageBeforeDigestingEnvName(
    ...
    if (invertPositionOfPlainSaltInEncryptionResultsEnvName != null) {
      config.setInvertPositionOfPlainSaltInEncryptionResultsEnvName(
