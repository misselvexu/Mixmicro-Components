...
/**
 * This implementation of {@link IvGenerator} holds a <b>secure</b> random generator which can be
 * used for generating random initialization vectors (IV) for encryption.
 *
...
public class RandomIvGenerator implements IvGenerator {
  ...
  /**
   * Creates a new instance of <tt>RandomIvGenerator</tt> using the default secure random number
  ...
  /**
   * Creates a new instance of <tt>RandomIvGenerator</tt> specifying a secure random number
   * generation algorithm.
   */
  ...
  /**
   * This IV generator needs the IV to be included unencrypted in encryption results, because of its
   * being random. This method will always return true.
   *
   * @return true
   */
