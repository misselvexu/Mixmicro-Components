...
/**
 * Implementation for {@link StringDigesterConfig} which can retrieve configuration values from
...
public class EnvironmentStringDigesterConfig extends EnvironmentDigesterConfig
  ...
  /**
   * Retrieve the name of the environment variable which value has been loaded as a value for the
   * "unicode normalization ignored" parameter.
   *
   ...
   * "unicode normalization ignored" parameter.
   *
   * @param unicodeNormalizationIgnoredEnvName the name of the environment variable
   */
    ...
    if (unicodeNormalizationIgnoredEnvName == null) {
      ...
      if (unicodeNormalizationIgnoredValue != null) {
        this.unicodeNormalizationIgnored =
            CommonUtils.getStandardBooleanValue(unicodeNormalizationIgnoredValue);
      } else {
        this.unicodeNormalizationIgnored = null;
      }
    }
  ...
  /**
   * Retrieve the name of the JVM system property which value has been loaded as a value for the
   * "unicode normalization ignored" parameter.
   *
  ...
  /**
   * Set the config object to use the specified JVM system property to load a value for the "unicode
   * normalization ignored" parameter.
   *
   * @param unicodeNormalizationIgnoredSysPropertyName the name of the property
   */
  public void setUnicodeNormalizationIgnoredSysPropertyName(
  ...
  /**
   * Retrieve the name of the environment variable which value has been loaded as the String output
   * type.
   *
   * @return the name of the variable
   */
  ...
  public void setStringOutputTypeEnvName(final String stringOutputTypeEnvName) {
    ...
    if (stringOutputTypeEnvName == null) {
      ...
      this.stringOutputType =
          CommonUtils.getStandardStringOutputType(System.getenv(stringOutputTypeEnvName));
    }
  }

  /**
   * Retrieve the name of the JVM system property which value has been loaded as the String output
   * type.
   *
   * @return the name of the property
   */
  ...
  /**
   * Set the config object to use the specified JVM system property to load the value for the String
   * output type.
   *
   ...
   *
   * @since 1.7
   * @param prefixEnvName the name of the environment variable
   */
  ...
  /**
   * Set the config object to use the specified JVM system property to load a value for the "prefix"
   * parameter.
   *
   * @since 1.7
   ...
   *
   * @since 1.7
   * @param suffixEnvName the name of the environment variable
   */
  ...
  /**
   * Set the config object to use the specified JVM system property to load a value for the "suffix"
   * parameter.
   *
   * @since 1.7
