...
/**
 * Common interface for all digesters which receive a byte array message and return a byte array
 * digest.
 *
 * <p>For a default implementation, see {@link StandardByteDigester}.
 *
 * @since 1.0
