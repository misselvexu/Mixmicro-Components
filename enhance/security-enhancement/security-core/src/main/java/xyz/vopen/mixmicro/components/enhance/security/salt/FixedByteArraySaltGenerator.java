 ...
 *     implements the new {@link FixedSaltGenerator} interface and therefore is able to benefit from
 *     the performance improvements associated with it. This class will be removed in 1.10.0 (or
 *     2.0.0).
 */
