...
/**
 * Utility class for easily performing password digesting and checking according to {SMD5}, a
...
public final class RFC2307SMD5PasswordEncryptor implements PasswordEncryptor {
   ...
   * match.
   *
   * <p>This password encryptor expects encrypted passwords being matched to include the "{SMD5}"
