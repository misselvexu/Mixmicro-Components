 ...
 */
public final class MixmicroSecurityPBEStringDecryptionCLI {
  ...
  public static void main(final String[] args) {
    ...
    try {
      ...
      if (args[0] == null || args[0].indexOf("=") != -1) {
        applicationName = MixmicroSecurityPBEStringDecryptionCLI.class.getName();
        arguments = args;
      } else {
   ...
   */
  private MixmicroSecurityPBEStringDecryptionCLI() {
    super();
  }
}
