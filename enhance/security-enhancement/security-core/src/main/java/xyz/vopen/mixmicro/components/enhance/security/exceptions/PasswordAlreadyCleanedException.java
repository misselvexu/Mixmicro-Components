...
/**
 * Exception thrown when an attempt is made to access the configured password of an encryptor when
 * this password has already been cleaned (so that it appears no more as an immutable String in
 * memory).
 *
 * @since 1.8
...
public final class PasswordAlreadyCleanedException extends RuntimeException {
  ...
  public PasswordAlreadyCleanedException() {
    super(
        "Password already cleaned: The encryptor that uses this password has "
