...
/**
 * Implementation for {@link PBEConfig} which can retrieve configuration values from environment
...
public class EnvironmentPBEConfig extends SimplePBEConfig {
  ...
  /**
   * Retrieve the name of the environment variable which value has been loaded as the key obtention
   * iteration count.
   *
   * @return the name of the variable
   */
  ...
  /**
   * Set the config object to use the specified environment variable to load the value for the key
   * obtention iteration count.
   *
  ...
  /**
   * Retrieve the name of the JVM system property which value has been loaded as the key obtention
   * iteration count.
   *
   * @return the name of the property
   */
  ...
  /**
   * Set the config object to use the specified JVM system property to load the value for the key
   * obtention iteration count.
   *
   * @param keyObtentionIterationsSysPropertyName the name of the property
   */
  public void setKeyObtentionIterationsSysPropertyName(
   ...
   * it can be instantiated and passed to the encryptor.
   *
   * @since 1.3
  ...
  /**
   * Retrieve the name of the environment variable which value has been loaded as the IV generator
   * class name.
   *
   * @since 1.9.3
   * @return the name of the variable
  ...
  /**
   * Set the config object to use the specified environment variable to load the value for the IV
   * generator class name.
   *
   * <p>The IV generator class name which is set here must have a no-argument constructor, so that
   * it can be instantiated and passed to the encryptor.
   *
   * @since 1.9.3
  ...
  /**
   * Retrieve the name of the JVM system property which value has been loaded as the IV generator
   * class name.
   *
   * @since 1.9.3
   * @return the name of the property
  ...
  /**
   * Set the config object to use the specified JVM system property to load the value for the IV
   * generator class name.
   *
   * <p>The IV generator class name which is set here must have a no-argument constructor, so that
   * it can be instantiated and passed to the encryptor.
   ...
   * can be instantiated and passed to the encryptor.
   *
   * @since 1.3
