...
final class CLIUtils {
  ...
  static boolean getVerbosity(final String[] args) {
    for (int i = 0; i < args.length; i++) {
      ...
      if (ArgumentNaming.ARG_VERBOSE.equals(key)) {
        final Boolean verbosity = CommonUtils.getStandardBooleanValue(value);
   ...
   */
  static Properties getArgumentValues(
      final String appName,
      final String[] args,
      final String[][] requiredArgNames,
      final String[][] optionalArgNames) {
  ...
  static void showUsageAndExit(
      final String appName, final String[][] requiredArgNames, final String[][] optionalArgNames) {
