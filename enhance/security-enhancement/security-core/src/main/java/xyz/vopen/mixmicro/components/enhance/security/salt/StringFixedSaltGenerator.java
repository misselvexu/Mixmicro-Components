...
/**
 * String based implementation of {@link FixedSaltGenerator}, that will always return the same salt.
 * This salt is returned as bytes using the specified charset for conversion (UTF-8 by default).
 *
...
public class StringFixedSaltGenerator implements FixedSaltGenerator {
  ...
  /**
   * Creates a new instance of <tt>FixedStringSaltGenerator</tt> using the default charset.
   *
