...
/**
 * Pooled implementation of {@link ByteDigester} that in fact contains an array of {@link
 * StandardByteDigester} objects which are used to attend digest and match requests in round-robin.
 * This should result in higher performance in multiprocessor systems.
 *
 * <p>Configuration of this class is equivalent to that of {@link StandardByteDigester}.
 *
