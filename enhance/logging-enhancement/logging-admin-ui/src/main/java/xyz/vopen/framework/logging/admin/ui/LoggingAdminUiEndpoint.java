...
public class LoggingAdminUiEndpoint {
    ...
    /**
     * {@link LoggingDataRepository} implement class instance
     */
    ...
    public List<LoggingResponse> logs(
        ...
        try {
            List<LoggingResponse> loggingResponseList = loggingDataRepository.findTopList(queryCount);
    ...
    @ResponseBody
    public List<LogServiceDetailModel> applications() {
        try {
            List<LogServiceDetailModel> serviceResponseList = loggingDataRepository.findAllServiceDetails();
