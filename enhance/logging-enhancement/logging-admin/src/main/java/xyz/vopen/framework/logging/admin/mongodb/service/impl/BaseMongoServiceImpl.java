 ...
 */
public abstract class BaseMongoServiceImpl<R extends BaseMongoRepository<E>, E>
    implements BaseMongoService<E> {
   ...
   * @return base mongo service
   */
  public BaseMongoServiceImpl<R, E> setRepository(R repository) {
