...
/**
 * The algorithm parameter contains the name of the signature's Algorithm, as registered in the HTTP
 * Signature Algorithms Registry defined by this document.
 *
 * <p>The signature verification is based on the signature's algorithm from the keyId parameter
 * rather than from this algorithm. If algorithm is provided and differs from or is incompatible
 * with the algorithm or key material identified by keyId (for example, algorithm has a value of
 * rsa-sha256 but keyId identifies an EdDSA key), then a verification exception is raised.
 *
 * <p>The default value for this parameter should be "hs2019".
 *
 * @author <a href="mailto:iskp.me@gmail.com">Elve.Xu</a>
 * @see <a
 *     href="https://www.ietf.org/id/draft-ietf-httpbis-message-signatures-00.html">https://www.ietf.org/id/draft-ietf-httpbis-message-signatures-00.html</a>
 */
public enum SigningAlgorithm {
   ...
   *
   * <p>Recommend support for: RSASSA-PSS [RFC8017] using SHA-512 [RFC6234] HMAC [RFC2104] using
   * SHA-512 [RFC6234] ECDSA using curve P-256 [DSS] and SHA-512 [RFC6234] Ed25519ph, Ed25519ctx,
   * and Ed25519 [RFC8032]
   */
  HS2019("hs2019", null),
  ...
  private static final Map<String, SigningAlgorithm> aliases =
      new HashMap<String, SigningAlgorithm>();
   ...
   * only of lower-case characters ("a" - "z"), digits ("0" - "9"), and hyphens ("-"), and SHOULD
   * NOT exceed 20 characters in length. The identifier MUST be unique within the context of the
   * registry.
   */
  ...
  public static SigningAlgorithm get(final String name) {
    ...
    throw new xyz.vopen.mixmicro.components.enhance.aksk.core.signatures
        .UnsupportedAlgorithmException(name);
  }
