...
import static xyz.vopen.mixmicro.components.enhance.rpc.json.JsonRpcBasicServer.ERROR;
import static xyz.vopen.mixmicro.components.enhance.rpc.json.JsonRpcBasicServer.ID;
import static xyz.vopen.mixmicro.components.enhance.rpc.json.JsonRpcBasicServer.JSONRPC;
import static xyz.vopen.mixmicro.components.enhance.rpc.json.JsonRpcBasicServer.METHOD;
