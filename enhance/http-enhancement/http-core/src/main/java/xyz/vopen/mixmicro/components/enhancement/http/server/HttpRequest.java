...
import xyz.vopen.mixmicro.components.enhancement.http.BytesInputStream;
import xyz.vopen.mixmicro.components.enhancement.http.HttpMethod;
...
public class HttpRequest {
  ...
  public void setHeaders(Map<String, Object> headers) {
    ...
    isKeepAlive = (version == HttpVersion.HTTP_1_1 && !"close".equals(con)) || "keep-alive".equals(con);
