...
import xyz.vopen.mixmicro.components.enhance.schedule.quartz.MongoHelper
...
import static xyz.vopen.mixmicro.components.enhance.schedule.quartz.Constants.STATE_ERROR
import static xyz.vopen.mixmicro.components.enhance.schedule.quartz.Constants.STATE_PAUSED
import static xyz.vopen.mixmicro.components.enhance.schedule.quartz.Constants.STATE_WAITING

class TriggerRepositoryTest extends Specification {

    @Shared
            triggerKey = new TriggerKey("name", "default")

    def triggerDao = new TriggerRepository(MongoHelper.getTriggersColl(),
            new QueryHelper(),
