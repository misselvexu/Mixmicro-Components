...
import xyz.vopen.mixmicro.components.enhance.schedule.quartz.JobDataConverter;
...
import static xyz.vopen.mixmicro.components.enhance.schedule.quartz.util.Keys.KEY_NAME;
...
public class TriggerConverter {
  ...
  public TriggerConverter(JobRepository jobRepository, JobDataConverter jobDataConverter) {
  ...
  public OperableTrigger toTriggerWithOptionalJob(TriggerKey triggerKey, Document triggerDoc)
    ...
    Document job = jobRepository.getById(jobId);
