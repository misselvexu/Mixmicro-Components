...
public class MisfireHandler {
  ...
  public MisfireHandler(
      CalendarRepository calendarRepository, SchedulerSignaler signaler, long misfireThreshold) {
  ...
  private Calendar retrieveCalendar(OperableTrigger trigger) throws JobPersistenceException {
    return calendarRepository.retrieveCalendar(trigger.getCalendarName());
  }
}
