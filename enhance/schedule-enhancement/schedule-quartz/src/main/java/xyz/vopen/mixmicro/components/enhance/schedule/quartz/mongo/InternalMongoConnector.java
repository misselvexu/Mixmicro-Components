...
public class InternalMongoConnector implements MongoConnector {
  ...
  /**
   * Constructs an instance of {@link InternalMongoConnector} from connection URI and option
   * builder.
   *
   * @param writeConcern instance of {@link WriteConcern}. Each {@link MongoCollection} produced by
   *     {@link #getCollection(String)} will be configured with this write concern.
  ...
  private static MongoClient createClient(final MongoClientSettings settings)
      throws SchedulerConfigException {
    try {
  ...
  private static MongoClient createClient(
      final String uri, final MongoClientSettings.Builder settingsBuilder)
      throws SchedulerConfigException {
  ...
  /**
   * Creates an instance of MongoClient from server addresses, credentials and settings builder
   * wrapping exception.
   */
  private static MongoClient createClient(
      final List<ServerAddress> seeds,
