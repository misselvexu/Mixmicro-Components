...
public class MongoDBJobStore implements JobStore, Constants {
  ...
  public void storeJob(JobDetail newJob, boolean replaceExisting) throws JobPersistenceException {
    assembler.jobRepository.storeJobInMongo(newJob, replaceExisting);
  }
  ...
  public void storeJobsAndTriggers(
    ...
    for (Entry<JobDetail, Set<? extends Trigger>> entry : triggersAndJobs.entrySet()) {
      ...
      assembler.jobRepository.storeJobInMongo(newJob, replace);
  ...
  public JobDetail retrieveJob(JobKey jobKey) throws JobPersistenceException {
    return assembler.jobRepository.retrieveJob(jobKey);
  }
  ...
  public OperableTrigger retrieveTrigger(TriggerKey triggerKey) throws JobPersistenceException {
    return assembler.triggerRepository.getTrigger(triggerKey);
  }

  @Override
  public boolean checkExists(JobKey jobKey) throws JobPersistenceException {
    return assembler.jobRepository.exists(jobKey);
  }

  @Override
  public boolean checkExists(TriggerKey triggerKey) throws JobPersistenceException {
    return assembler.triggerRepository.exists(Keys.toFilter(triggerKey));
  }

  @Override
  public void clearAllSchedulingData() throws JobPersistenceException {
    assembler.jobRepository.clear();
    assembler.triggerRepository.clear();
    assembler.calendarRepository.clear();
    assembler.pausedJobGroupsRepository.remove();
    assembler.pausedTriggerGroupsRepository.remove();
  }
  ...
  public void storeCalendar(
    ...
    assembler.calendarRepository.store(name, calendar);
  }

  @Override
  public boolean removeCalendar(String calName) throws JobPersistenceException {
    return assembler.calendarRepository.remove(calName);
  }

  @Override
  public Calendar retrieveCalendar(String calName) throws JobPersistenceException {
    return assembler.calendarRepository.retrieveCalendar(calName);
  }

  @Override
  public int getNumberOfJobs() throws JobPersistenceException {
    return assembler.jobRepository.getCount();
  }

  @Override
  public int getNumberOfTriggers() throws JobPersistenceException {
    return assembler.triggerRepository.getCount();
  }

  @Override
  public int getNumberOfCalendars() throws JobPersistenceException {
    return assembler.calendarRepository.getCount();
  }

  @Override
  public Set<JobKey> getJobKeys(GroupMatcher<JobKey> matcher) throws JobPersistenceException {
    return assembler.jobRepository.getJobKeys(matcher);
  }

  @Override
  public Set<TriggerKey> getTriggerKeys(GroupMatcher<TriggerKey> matcher)
      throws JobPersistenceException {
    return assembler.triggerRepository.getTriggerKeys(matcher);
  }

  @Override
  public List<String> getJobGroupNames() throws JobPersistenceException {
    return assembler.jobRepository.getGroupNames();
  }

  @Override
  public List<String> getTriggerGroupNames() throws JobPersistenceException {
    return assembler.triggerRepository.getGroupNames();
  }

  @Override
  public List<String> getCalendarNames() throws JobPersistenceException {
    return assembler.calendarRepository.retrieveCalendarNames();
  }
  ...
  public Set<String> getPausedJobGroups() throws JobPersistenceException {
    return assembler.pausedJobGroupsRepository.getPausedGroups();
  }
  ...
  public MongoCollection<Document> getJobCollection() {
    return assembler.jobRepository.getCollection();
  }

  public MongoCollection<Document> getTriggerCollection() {
    return assembler.triggerRepository.getCollection();
  }

  public MongoCollection<Document> getCalendarCollection() {
    return assembler.calendarRepository.getCollection();
  }

  public MongoCollection<Document> getLocksCollection() {
    return assembler.locksRepository.getCollection();
  }
  ...
  private void ensureIndexes() throws SchedulerConfigException {
    try {
      ...
      assembler.jobRepository.createIndex();
      assembler.triggerRepository.createIndex();
      assembler.locksRepository.createIndex(isClustered());
      assembler.calendarRepository.createIndex();
      assembler.schedulerRepository.createIndex();

      try {
        // Drop the old indexes that were declared as name then group rather than group then name
        assembler.jobRepository.dropIndex();
        assembler.triggerRepository.dropIndex();
        assembler.locksRepository.dropIndex();
