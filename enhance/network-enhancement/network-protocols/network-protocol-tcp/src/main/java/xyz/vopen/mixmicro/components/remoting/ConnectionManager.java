...
public interface ConnectionManager extends Scannable, LifeCycle {
  ...
  /**
   * Add a connection to {@link ConnectionPool}. If it contains multiple pool keys, this connection
   * will be added to multiple {@link ConnectionPool} too.
   *
   * @param connection an available connection, you should {@link #check(Connection)} this
  ...
  /**
   * Remove a {@link Connection} from all {@link ConnectionPool} with the poolKeys in {@link
  ...
  /**
   * Remove and close all connections from all {@link ConnectionPool}. Deprecated, use shutdown
   * instead.
   */
  @Deprecated
  void removeAll();
  ...
  /**
   * Get a connection using {@link Url}, if {@code null} then create and add into {@link
   * ConnectionPool}. The connection number of {@link ConnectionPool} is decided by {@link
   * Url#getConnNum()}
   *
  ...
  /**
   * This method can create connection pool with connections initialized and check the number of
   * connections. The connection number of {@link ConnectionPool} is decided by {@link
   * Url#getConnNum()}. Each time call this method, will check the number of connection, if not
   * enough, this will do the healing logic additionally.
   */
