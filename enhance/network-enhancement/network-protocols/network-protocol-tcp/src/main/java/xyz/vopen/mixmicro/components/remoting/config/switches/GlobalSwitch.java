 ...
 */
package xyz.vopen.mixmicro.components.remoting.config.switches;
...
public class GlobalSwitch implements Switch {
  ...
  /**
   * Init with system default value if settings exist by system property then use system property at
   * first; if no settings exist by system property then use default value in {@link Configs} All
   * these settings can be overwrite by user api settings.
   */
  public GlobalSwitch() {
