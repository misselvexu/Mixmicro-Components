...
/**
 * Protocol code based newEncoder, the main newEncoder for a certain protocol, which is lead by one
 * or multi bytes (magic code).
 *
 * <p>Notice: this is stateless can be noted as {@link io.netty.channel.ChannelHandler.Sharable}
 *
