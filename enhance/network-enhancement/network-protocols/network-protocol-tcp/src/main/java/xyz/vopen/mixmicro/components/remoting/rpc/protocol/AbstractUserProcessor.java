...
import xyz.vopen.mixmicro.components.remoting.DefaultBizContext;
 ...
 */
public abstract class AbstractUserProcessor<T> extends AbstractLifeCycle
   ...
   *
   * @see UserProcessor#preHandleRequest(RemotingContext, java.lang.Object)
   */
  @Override
