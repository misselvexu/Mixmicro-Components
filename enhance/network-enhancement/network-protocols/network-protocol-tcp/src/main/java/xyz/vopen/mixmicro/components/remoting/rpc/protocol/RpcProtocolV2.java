...
import xyz.vopen.mixmicro.components.remoting.CommandEncoder;
import xyz.vopen.mixmicro.components.remoting.CommandFactory;
import xyz.vopen.mixmicro.components.remoting.CommandHandler;
import xyz.vopen.mixmicro.components.remoting.HeartbeatTrigger;
import xyz.vopen.mixmicro.components.remoting.Protocol;
import xyz.vopen.mixmicro.components.remoting.rpc.RpcCommandFactory;
...
public class RpcProtocolV2 implements Protocol {
  ...
  /**
   * in contrast to protocol v1, one more byte is used as protocol version, and another one is userd
   * as protocol switch
   */
