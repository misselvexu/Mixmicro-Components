...
import xyz.vopen.mixmicro.components.remoting.util.ConnectionUtil;
...
public class RemotingContext {
  ...
  /**
   * whether need handle request timeout, if true, request will be discarded. The default value is
   * true
   */
