...
public class Url {
   ...
   *
   * <ul>
   *   <li>Initialize ip:port as {@link Url#originUrl}
   *   <li>Initialize {@link Url#originUrl} as {@link Url#uniqueKey}
   * </ul>
   *
   * @param ip
   * @param port
   ...
   *
   * <ul>
   *   <li>Initialize @param originUrl as {@link Url#originUrl}
   *   <li>Initialize ip:port as {@link Url#uniqueKey}
   * </ul>
   *
   * @param originUrl
   * @param ip
   ...
   *   <li>Initialize @param originUrl as {@link Url#originUrl}
   *   <li>Initialize ip:port as {@link Url#uniqueKey}
   *   <li>Initialize @param properties as {@link Url#properties}
   * </ul>
   *
   * @param originUrl
   * @param ip
   ...
   * <ul>
   *   <li>Initialize @param originUrl as {@link Url#originUrl}
   *   <li>Initialize @param uniqueKey as {@link Url#uniqueKey}
   *   <li>Initialize @param properties as {@link Url#properties}
   * </ul>
   *
   * @param originUrl
  ...
  public void setConnNum(int connNum) {
    if (connNum <= 0 || connNum > Configs.MAX_CONN_NUM_PER_URL) {
      throw new IllegalArgumentException(
          "Illegal value of connection number ["
              + connNum
