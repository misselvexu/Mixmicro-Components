...
import xyz.vopen.mixmicro.components.remoting.CustomSerializer;
import xyz.vopen.mixmicro.components.remoting.CustomSerializerManager;
...
import xyz.vopen.mixmicro.components.remoting.util.IDGenerator;
  ...
  public void serializeContent(InvokeContext invokeContext) throws SerializationException {
    if (this.requestObject != null) {
      try {
        ...
        this.setContent(
            SerializerManager.getSerializer(this.getSerializer()).serialize(this.requestObject));
      } catch (SerializationException e) {
        throw e;
      } catch (Exception e) {
        throw new SerializationException(
      ...
      try {
        ...
        if (this.getContent() != null) {
          this.setRequestObject(
              SerializerManager.getSerializer(this.getSerializer())
