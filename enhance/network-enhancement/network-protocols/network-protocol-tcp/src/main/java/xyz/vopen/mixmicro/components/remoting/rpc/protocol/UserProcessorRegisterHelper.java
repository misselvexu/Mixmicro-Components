...
public class UserProcessorRegisterHelper {
   ...
   */
  public static void registerUserProcessor(
      UserProcessor<?> processor, ConcurrentHashMap<String, UserProcessor<?>> userProcessors) {
    if (null == processor) {
   ...
   * @param userProcessors the map of user processors
   */
  private static void registerUserProcessor(
      MultiInterestUserProcessor<?> processor,
