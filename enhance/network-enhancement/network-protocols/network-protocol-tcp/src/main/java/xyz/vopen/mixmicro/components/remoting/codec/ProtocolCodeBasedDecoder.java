...
/**
 * Protocol code based decoder, the main decoder for a certain protocol, which is lead by one or
 * multi bytes (magic code).
 *
 * <p>Notice: this is not stateless, can not be noted as {@link
    ...
    if (null != protocolCode) {
      ...
      if (null != protocol) {
        ...
        throw new CodecException(
            "Unknown protocol code: [" + protocolCode + "] while decode in ProtocolDecoder.");
      }
    }
  }
}
