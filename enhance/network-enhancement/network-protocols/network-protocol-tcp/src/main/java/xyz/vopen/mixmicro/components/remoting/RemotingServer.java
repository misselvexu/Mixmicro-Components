...
/** @author Elve.Xu (iskp.me@gmail.com) 2018-06-16 06:55 */
public interface RemotingServer extends Configurable, LifeCycle {
   ...
   *
   * <p>Remoting server can not be used any more after stop. If you need, you should destroy it, and
  ...
  void registerProcessor(
      byte protocolCode, CommandCode commandCode, RemotingProcessor<?> processor);
   ...
   *
   * @param processor user processor which can be a single-interest processor or a multi-interest
   *     processor
   */
