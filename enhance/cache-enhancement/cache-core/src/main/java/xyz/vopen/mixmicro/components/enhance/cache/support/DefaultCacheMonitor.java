  ...
  private void parseSingleGet(CacheGetResult result) {
    switch (result.getResultCode()) {
      ...
      case FAIL:
        ...
        break;
      default:
        logger.warn("mixcache get return unexpected code: " + result.getResultCode());
    }
  }
  ...
  private void afterPut(long millis, Object key, Object value, CacheResult result) {
    ...
    switch (result.getResultCode()) {
      ...
      case EXISTS:
        break;
      default:
        logger.warn("mixcache PUT return unexpected code: " + result.getResultCode());
    }
  }
  ...
  private void afterRemove(long millis, Object key, CacheResult result) {
    ...
    switch (result.getResultCode()) {
      ...
      case PART_SUCCESS:
        ...
        break;
      default:
        logger.warn("mixcache REMOVE return unexpected code: " + result.getResultCode());
    }
  }
