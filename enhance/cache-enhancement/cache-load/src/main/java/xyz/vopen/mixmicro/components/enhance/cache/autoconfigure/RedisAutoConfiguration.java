...
import xyz.vopen.mixmicro.components.enhance.cache.redis.RedisCacheBuilder;
...
public class RedisAutoConfiguration {
  ...
  public static class RedisCondition extends MixCacheCondition {
  ...
  public static class RedisAutoInit extends ExternalCacheAutoInit {
    ...
    protected CacheBuilder initCache(ConfigTree ct, String cacheAreaWithPrefix) {
      ...
      ExternalCacheBuilder externalCacheBuilder =
          RedisCacheBuilder.createRedisCacheBuilder()
              .jedisPool(jedisPool)
    ...
    private Pool<Jedis> parsePool(ConfigTree ct) {
      ...
      if (sentinels == null) {
        ...
        jedisPool =
            new JedisPool(poolConfig, host, port, timeout, password, database, clientName, ssl);
      } else {
        ...
        jedisPool =
            new JedisSentinelPool(
                masterName, sentinelsSet, poolConfig, timeout, password, database, clientName);
      }
      return jedisPool;
    }
    ...
    private GenericObjectPoolConfig parsePoolConfig(ConfigTree ct) {
      try {
        ...
        if (ClassUtils.isPresent(
          ...
          Class<?> bindableClass =
              Class.forName("org.springframework.boot.context.properties.bind.Bindable");
          Class<?> bindResultClass =
              Class.forName("org.springframework.boot.context.properties.bind.BindResult");
          ...
          Class<?> relaxedDataBinderClass =
              Class.forName("org.springframework.boot.bind.RelaxedDataBinder");
          Class<?> mutablePropertyValuesClass =
              Class.forName("org.springframework.beans.MutablePropertyValues");
