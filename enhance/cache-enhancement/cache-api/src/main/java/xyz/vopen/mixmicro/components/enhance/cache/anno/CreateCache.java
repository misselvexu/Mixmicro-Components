...
public @interface CreateCache {
    ...
    /**
     * The name of this Cache instance, optional. If you do not specify, MixCache will auto generate one.
     ...
     * The MixCache build-in serialPolicy are SerialPolicy.JAVA or SerialPolicy.KRYO.
     * Use global config if the attribute value is absent, and if the global config is not defined either,
     ...
     * The MixCache build-in keyConvertor are KeyConvertor.FASTJSON or KeyConvertor.NONE.
