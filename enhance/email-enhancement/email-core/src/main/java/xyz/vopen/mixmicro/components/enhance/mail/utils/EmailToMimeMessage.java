...
package xyz.vopen.mixmicro.components.enhance.mail.utils;
...
import static xyz.vopen.mixmicro.components.enhance.mail.utils.StringUtils.EMPTY;
import static java.util.Objects.nonNull;
import static java.util.Optional.ofNullable;

@Component
@Slf4j
public class EmailToMimeMessage implements Function<MixmicroEmail, MimeMessage> {
  ...
  @Override
  public MimeMessage apply(final MixmicroEmail email) {
    ...
    try {
      ...
      if (isMultipart) {
        for (final MixmicroEmailAttachment attachment : email.getAttachments()) {
  ...
  protected void setCustomHeaders(MixmicroEmail email, MimeMessage mimeMessage) {
