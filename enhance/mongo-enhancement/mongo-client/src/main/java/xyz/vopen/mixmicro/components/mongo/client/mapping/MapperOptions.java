...
public class MapperOptions {
   ...
   * @deprecated This will be removed in 2.0. It is intended to bridge the gap when correcting the
   *     storage of data/time values in the database. {@link DateStorage#UTC} should be used and
   *     will be the default in 2.0. In 1.5 it is {@link DateStorage#SYSTEM_DEFAULT} for backwards
   *     compatibility.
   */
  @Deprecated
   ...
   * @deprecated continued use of this method will result in different options being applied in 2.0.
   *     To maintain the current settings please use {@link #legacy()} instead.
   * @see #legacy()
   */
  @Deprecated
