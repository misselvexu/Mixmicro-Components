...
public abstract class OperationValidator implements Validator {
   ...
   * @param validationFailures the list to add any new {@code ValidationFailures} to. If validation
   *     passed this list will not change.
   */
  protected abstract void validate(
      MappedField mappedField, Object value, List<ValidationFailure> validationFailures);
}
