...
public abstract class TypeValidator implements Validator {
   ...
   * getTypeClasses, the validation is not applied and this method returns false. If the type is in
   * the list, then the validate method is called to see if the value is of a type that can be
