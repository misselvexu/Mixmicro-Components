...
import xyz.vopen.mixmicro.components.mongo.client.annotations.AlsoLoad;
import xyz.vopen.mixmicro.components.mongo.client.annotations.ConstructorArgs;
...
public class MappedField {
  ...
  private List<String>
      loadNames; // List of stored names in order of trying, contains nameToStore and potential
                 // aliases
  ...
  private Constructor discoverConstructor() {
    ...
    if (type != null) {
      ...
      // short circuit to avoid wasting time throwing an exception trying to get a constructor we
      // know doesnt exist
