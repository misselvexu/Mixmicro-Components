...
public interface UpdateOperations<T> {
   ...
   * @return this
   * <p>mongodb.driver.manual reference/operator/update/addToSet/ $addToSet
   ...
   * @return this
   * <p>mongodb.driver.manual reference/operator/update/addToSet/ $addToSet
   * <p>mongodb.driver.manual reference/operator/update/push/ $push
   * @deprecated use {@link #push(String, Object)} if addDups is true or {@link #addToSet(String,
   *     Object)} instead
   */
  @Deprecated
   ...
   * <p>mongodb.driver.manual reference/operator/update/addToSet/ $addToSet
   * <p>mongodb.driver.manual reference/operator/update/push/ $push
   * @deprecated use {@link #push(String, List)} if addDups is true or {@link #addToSet(String,
   *     List)}
   */
  @Deprecated
   ...
   * @param field the field to update
   * @return this
   * <p>mongodb.driver.manual reference/operator/update/inc/ $inc
   */
   ...
   *
   * @return this
   * <p>mongodb.driver.manual reference/operator/update/isolated/ $isolated
   ...
   * @return this
   * <p>mongodb.driver.manual reference/operator/update/max/ $max
   */
   ...
   * @param value the value to use
   * @return this
   * <p>mongodb.driver.manual reference/operator/update/min/ $min
   */
   ...
   * @param value the value to use
   * @return this
   * <p>mongodb.driver.manual reference/operator/update/pull/ $pull
   */
   ...
   * @return this
   * <p>mongodb.driver.manual reference/operator/update/pullAll/ $pullAll
   */
   ...
   * @param field the field to update
   * @return this
   * <p>mongodb.driver.manual reference/operator/update/pop/ $pop
   */
   ...
   * @param value the value to use
   * @return this
   * <p>mongodb.driver.manual reference/operator/update/set/ $set
   */
   ...
   * @param value the value to use
   * @return this
   * <p>mongodb.driver.manual reference/operator/update/setOnInsert/ $setOnInsert
   */
   ...
   * @param field the field to update
   * @return this
   * <p>mongodb.driver.manual reference/operator/update/unset/ $unset
   */
