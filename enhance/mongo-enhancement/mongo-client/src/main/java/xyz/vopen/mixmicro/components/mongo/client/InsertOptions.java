...
public class InsertOptions {
  ...
  /**
   * Whether documents will continue to be inserted after a failure to insert one (most commonly due
   * to a duplicate key error). Note that this only is relevant for multi-document inserts. The
