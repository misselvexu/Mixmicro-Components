...
import xyz.vopen.mixmicro.components.mongo.client.geo.CoordinateReferenceSystem;
import xyz.vopen.mixmicro.components.mongo.client.geo.Geometry;
import xyz.vopen.mixmicro.components.mongo.client.geo.MultiPolygon;
import xyz.vopen.mixmicro.components.mongo.client.geo.Point;
import xyz.vopen.mixmicro.components.mongo.client.geo.Polygon;
...
public interface FieldEnd<T> {
   ...
   * @return T
   * <p>mongodb.driver.manual reference/operator/query/regex/ $regex
   */
   ...
   *
   * @return T
   * <p>mongodb.driver.manual reference/operator/query/exists/ $exists
   */
  T doesNotExist();
   ...
   * @return T
   * <p>mongodb.driver.manual reference/operator/query/eq/ $eq
   */
  T equal(Object val);
   ...
   * @return T
   * <p>mongodb.driver.manual reference/operator/query/gt/ $gt
   */
   ...
   * @param val the value to check against
   * @return T
   * <p>mongodb.driver.manual reference/operator/query/gte/ $gte
   */
   ...
   * @return T
   * <p>mongodb.driver.manual reference/operator/query/all/ $all
   */
   ...
   * @param values the values to check against
   * @return T
   * <p>mongodb.driver.manual reference/operator/query/in/ $in
   */
   ...
   * @param values the values to check against
   * @return T
   * <p>mongodb.driver.manual reference/operator/query/nin/ $nin
   */
  T hasNoneOf(Iterable<?> values);

  /**
   * Checks that a field has the value listed. The options to store null/empty values apply here so
   * to do partial matches on embedded objects, pass a reference to a partially populated instance
   * with only the values of interest set to the values to check.
   *
   * @param val the value to check against
   * @return T
   * <p>mongodb.driver.manual reference/operator/query/elemMatch/ $elemMatch
   * @see MapperOptions
  ...
  /**
   * This performs a $geoIntersects query, searching documents containing any sort of GeoJson field
   * and returning those where the given geometry intersects with the document shape. This includes
   * cases where the data and the specified object share an edge.
   *
   * @param geometry the shape to use to query for any stored shapes that intersect
   * @return T
   * <p>mongodb.driver.manual reference/operator/query/geoIntersects/ $geoIntersects
   * @since mongodb.server.release 2.4
   */
   ...
   * @param val the value to check against
   * @return T
   * <p>mongodb.driver.manual reference/operator/query/lt/ $lt
   */
   ...
   * @param val the value to check against
   * @return T
   * <p>mongodb.driver.manual reference/operator/query/lte/ $lte
   */
   ...
   * @return T
   * <p>mongodb.driver.manual reference/operator/query/mod/ $mod
   */
   ...
   * @return T
   * <p>mongodb.driver.manual reference/operator/query/near/ $near
   */
   ...
   * @return T
   * <p>mongodb.driver.manual reference/operator/query/near/ $near
   * <p>mongodb.driver.manual reference/operator/query/nearSphere/ $nearSphere
   */
   ...
   * Point represents a GeoJSON point type. These queries are only supported by MongoDB version 2.4
   * or greater.
   *
   ...
   * @param val the value to check
   * @return T
   * <p>mongodb.driver.manual reference/operator/query/ne/ $ne
   */
   ...
   * @param val the value to check against
   * @return T
   * <p>mongodb.driver.manual reference/operator/query/size/ $size
   */
  T sizeEq(int val);
   ...
   * @return T
   * <p>mongodb.driver.manual reference/operator/query/geoWithin/ $geoWithin
   * @since mongodb.server.release 2.4
   */
  T within(Shape shape);

  /**
   * This runs the $geoWithin query, returning documents with GeoJson fields whose area falls within
   * the given boundary. When determining inclusion, MongoDB considers the border of a shape to be
   * part of the shape, subject to the precision of floating point numbers.
   *
  ...
  /**
   * This runs the $geoWithin query, returning documents with GeoJson fields whose area falls within
   * the given boundaries. When determining inclusion, MongoDB considers the border of a shape to be
   * part of the shape, subject to the precision of floating point numbers.
   *
   * @param boundaries a multi-polygon describing the areas to search within.
   * @return T
   * <p>mongodb.driver.manual reference/operator/query/geoWithin/ $geoWithin
   * @since mongodb.server.release 2.6
   */
