...
public interface Query<T> extends QueryResults<T>, MongoIterable<T> {
  ...
  /**
   * This makes it possible to attach a comment to a query. Because these comments propagate to the
   * profile log, adding comments can make your profile data much easier to interpret and trace.
   *
   * @param comment the comment to add
   * @return the Query to enable chaining of commands
   * <p>mongodb.driver.manual reference/operator/meta/comment $comment
   * @deprecated use the methods that accept Options directly. This can be replicated with {@link
  ...
  /**
   * Provides information on the query plan. The query plan is the plan the server uses to find the
   * matches for a query. This information may be useful when optimizing a query.
   *
   * @return Map describing the process used to return the query results.
   * <p>mongodb.driver.manual reference/operator/meta/explain/ explain
   */
   ...
   * @deprecated use the methods that accept Options directly. This can be replicated with {@code
   ...
   * @return this
   * <p>mongodb.driver.manual reference/operator/meta/min/ $min
   * @deprecated use the methods that accept Options directly.
   ...
   * @return this
   * <p>mongodb.driver.manual reference/operator/meta/maxScan/#op._S_maxScan $maxScan
   ...
   * results. Projected fields must all be inclusions or exclusions. You can not include and exclude
   * fields at the same time with the exception of the _id field. The _id field is always included
   ...
   *     href="https://docs.mongodb.com/manual/tutorial/project-fields-from-query-results/">Project
   *     Fields to Return from Query</a>
   * <p>mongodb.driver.manual /reference/operator/projection/slice/ $slice
   */
  @Deprecated
   ...
   *     href="https://docs.mongodb.com/manual/tutorial/project-fields-from-query-results/">Project
   *     Fields to Return from Query</a>
   * <p>mongodb.driver.manual reference/operator/projection/meta/ $meta
   */
  @Deprecated
   ...
   * true and the query does not use an index to perform the read operation, the returned documents
   * will not contain any fields
   *
   * @return the Query to enable chaining of commands
   * <p>mongodb.driver.manual reference/operator/meta/returnKey/#op._S_returnKey $returnKey
   * @deprecated use the methods that accept Options directly.
   ...
   * @return the Query to enable chaining of commands
   * <p>mongodb.driver.manual reference/operator/query/text/ $text
   */
   ...
   * @return this
   * <p>mongodb.driver.manual reference/operator/meta/max/ $max
   * @deprecated use the methods that accept Options directly.
  ...
  /**
   * Execute the query and get the results (as a {@code List<Key<T>>}) This method is provided as a
   * convenience;
   *
   ...
   * actual results (transfers less data).
   *
   ...
   * @return an Iterator.
   * @see #tail(boolean)
   * @deprecated set the CursorType on {@link FindOptions} and use {@link #find(FindOptions)}
   *     instead
   */
  @Deprecated
   ...
   * iterator blocks on hasNext() until new data is avail (or some amount of time has passed). Note
   * that if no data is available at all, hasNext() might return immediately. You should wrap tail
   * calls in a loop if you want this to be blocking.
   *
   * @param awaitData passes the awaitData to the cursor
   * @return an Iterator.
   * @deprecated set the CursorType on {@link FindOptions} and use {@link #find(FindOptions)}
   *     instead. This can be replicated using {@code findOptions.cursorType (awaitData ?
