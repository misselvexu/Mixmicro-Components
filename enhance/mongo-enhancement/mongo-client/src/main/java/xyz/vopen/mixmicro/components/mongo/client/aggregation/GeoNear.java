...
import xyz.vopen.mixmicro.components.mongo.client.geo.GeometryShapeConverter;
...
public final class GeoNear {
   ...
   * of documents to return. If both options are included, the num value overrides the limit value.
   *
   * @return the maximum
   */
  ...
  /**
   * Required if using a 2dsphere index. Determines how MongoDB calculates the distance. The default
   * value is false.
   *
  ...
  /**
   * If this value is true, the query returns a matching document once, even if more than one of the
   * document's location fields match the query.
   *
   * @return true if returning only unique documents
   * @deprecated since version MongoDB 2.6: Geospatial queries no longer return duplicate results.
  ...
  public static class GeoNearBuilder {
    ...
    /**
     * This specifies the output field that identifies the location used to calculate the distance.
     * This option is useful when a location field contains multiple locations. To specify a field
     * within a subdocument, use dot notation.
     *
     * @param includeLocations the output field that identifies the location used to calculate the
     *     distance
     * @return this
     * @see <a href="http://docs.mongodb.org/master/reference/glossary/#term-dot-notation">dot
     *     notation</a>
    ...
    /**
     * A distance from the center point. Specify the distance in radians. MongoDB limits the results
     * to those documents that fall within the specified distance from the center point.
     *
     ...
     * maximum number of documents to return. If both options are included, this value overrides the
     * limit value.
     *
     ...
     * @return this
     * <p>mongodb.driver.manual tutorial/query-documents/ read operation query syntax
     */
     ...
     * the document's location fields match the query. If this value is false, the query returns a
     * document multiple times if the document has multiple matching location fields. See
     * $uniqueDocs for more information.
     *
     ...
     *     duplicate results. The $uniqueDocs operator has no impact on results.
     */
    @Deprecated
