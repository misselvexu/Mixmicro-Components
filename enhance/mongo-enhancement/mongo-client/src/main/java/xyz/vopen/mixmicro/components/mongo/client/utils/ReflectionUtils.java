package xyz.vopen.mixmicro.components.mongo.client.utils;
...
public final class ReflectionUtils {
  ...
  private static List<Method> getDeclaredAndInheritedMethods(
    ...
    final List<Method> list =
        getDeclaredAndInheritedMethods(parent, methods == null ? new ArrayList<Method>() : methods);
   ...
   * @return true if the field is parameterized and c is the class that parameterizes the field, or
   *     is an interface that the parameterized class implements, else false
   * @deprecated this class is unused in mix-mongo and will be removed in a future release
   */
  ...
  /**
   * Checks if the Class given is a primitive type. This includes the Java primitive types and their
   * wrapper types.
   *
   * @param type the Class to examine
  ...
  /**
   * Returns the (first) instance of the annotation, on the class (or any superclass, or interfaces
   * implemented).
   *
   * @param c the class to examine
   * @param annotation the annotation to find
