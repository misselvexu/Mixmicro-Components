...
public final class Group {
   ...
   * in a group of documents that share the same group by key. Order of the elements in the output
   * array is unspecified.
   *
   * @param field the field to process
   * @return an Accumulator
   * <p>mongodb.driver.manual reference/operator/aggregation/addToSet $addToSet
   */
   ...
   * @param field the field to process
   * @return an Accumulator
   * <p>mongodb.driver.manual reference/operator/aggregation/avg $avg
   */
   ...
   * documents that share the same group by key. Only meaningful when documents are in a defined
   * order.
   *
   * @param field the field to process
   * @return an Accumulator
   * <p>mongodb.driver.manual reference/operator/aggregation/first $first
   */
   ...
   * documents that share the same group by a field. Only meaningful when documents are in a defined
   * order.
   *
   * @param field the field to process
   * @return an Accumulator
   * <p>mongodb.driver.manual reference/operator/aggregation/last $last
   */
  ...
  /**
   * Returns the highest value that results from applying an expression to each document in a group
   * of documents that share the same group by key.
   *
   * @param field the field to process
   * @return an Accumulator
   * <p>mongodb.driver.manual reference/operator/aggregation/max $max
   */
   ...
   * @param field the field to process
   * @return an Accumulator
   * <p>mongodb.driver.manual reference/operator/aggregation/min $min
   */
   ...
   * @param field the field to process
   * @return an Accumulator
   * <p>mongodb.driver.manual reference/operator/aggregation/push $push
   */
  ...
  /**
   * Calculates and returns the sum of all the numeric values that result from applying a specified
   * expression to each document in a group of documents that share the same group by key. $sum
   * ignores non-numeric values.
   *
   * @param field the field to process
   * @return an Accumulator
   * <p>mongodb.driver.manual reference/operator/aggregation/sum $sum
   */
