 ...
 *
 * <p>mongodb.driver.manual tutorial/query-documents/ Find
 * <p>mongodb.driver.manual ../meta-driver/latest/legacy/mongodb-wire-protocol/#op-query OP_QUERY
 * @since 1.3
 */
public class FindOptions {
   ...
   * @return this
   * <p>mongodb.driver.manual reference/method/cursor.batchSize/#cursor.batchSize Batch Size
   */
   ...
   * @return this
   * @since mongodb.server.release 3.4
   */
  ...
  /**
   * Gets the number of documents to return per batch. Default to 0, which indicates that the server
   * chooses an appropriate batch size.
   *
   ...
   *
   * @return the limit
   * <p>mongodb.driver.manual reference/method/cursor.limit/#cursor.limit Limit
   */
  public int getLimit() {
   ...
   * query. This only applies to a TAILABLE_AWAIT cursor. When the cursor is not a TAILABLE_AWAIT
   * cursor, this option is ignored.
   *
   ...
   * <p>mongodb.driver.manual reference/method/cursor.maxTimeMS/#cursor.maxTimeMS Max Time
   */
   ...
   * <p>mongodb.driver.manual reference/method/cursor.skip/#cursor.skip Skip
   */
  public int getSkip() {
   ...
   * <p>mongodb.driver.manual reference/method/db.collection.find/ Projection
   */
   ...
   * <p>mongodb.driver.manual reference/method/cursor.sort/ Sort
   */
