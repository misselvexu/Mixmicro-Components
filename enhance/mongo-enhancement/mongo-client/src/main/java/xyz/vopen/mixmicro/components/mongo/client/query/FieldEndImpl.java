...
import static xyz.vopen.mixmicro.components.mongo.client.query.FilterOperator.ALL;
import static xyz.vopen.mixmicro.components.mongo.client.query.FilterOperator.ELEMENT_MATCH;
import static xyz.vopen.mixmicro.components.mongo.client.query.FilterOperator.EQUAL;
import static xyz.vopen.mixmicro.components.mongo.client.query.FilterOperator.EXISTS;
import static xyz.vopen.mixmicro.components.mongo.client.query.FilterOperator.GEO_WITHIN;
import static xyz.vopen.mixmicro.components.mongo.client.query.FilterOperator.GREATER_THAN;
import static xyz.vopen.mixmicro.components.mongo.client.query.FilterOperator.GREATER_THAN_OR_EQUAL;
import static xyz.vopen.mixmicro.components.mongo.client.query.FilterOperator.IN;
import static xyz.vopen.mixmicro.components.mongo.client.query.FilterOperator.INTERSECTS;
import static xyz.vopen.mixmicro.components.mongo.client.query.FilterOperator.LESS_THAN;
import static xyz.vopen.mixmicro.components.mongo.client.query.FilterOperator.LESS_THAN_OR_EQUAL;
import static xyz.vopen.mixmicro.components.mongo.client.query.FilterOperator.MOD;
import static xyz.vopen.mixmicro.components.mongo.client.query.FilterOperator.NEAR;
import static xyz.vopen.mixmicro.components.mongo.client.query.FilterOperator.NEAR_SPHERE;
import static xyz.vopen.mixmicro.components.mongo.client.query.FilterOperator.NOT_EQUAL;
import static xyz.vopen.mixmicro.components.mongo.client.query.FilterOperator.NOT_IN;
import static xyz.vopen.mixmicro.components.mongo.client.query.FilterOperator.SIZE;
import static xyz.vopen.mixmicro.components.mongo.client.query.FilterOperator.TYPE;
...
public class FieldEndImpl<T extends CriteriaContainer> implements FieldEnd<T> {
  ...
  @Override
  public T near(
      final double longitude, final double latitude, final double radius, final boolean spherical) {
