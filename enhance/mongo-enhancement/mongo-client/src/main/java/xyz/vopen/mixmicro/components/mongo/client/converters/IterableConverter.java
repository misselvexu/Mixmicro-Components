...
import xyz.vopen.mixmicro.components.mongo.client.mapping.EphemeralMappedField;
...
public class IterableConverter extends TypeConverter {
  ...
  public Object decode(final Class targetClass, final Object fromDBObject, final MappedField mf) {
    ...
    if (fromDBObject.getClass().isArray()) {
        ...
        if (o instanceof DBObject) {
          ...
          if (!typeParameters.isEmpty()) {
            ...
            if (mappedField instanceof EphemeralMappedField) {
              values.add(
                  converters.decode(
                      (subtypeDest != null) ? subtypeDest : o.getClass(), o, mappedField));
            } else {
              throw new UnsupportedOperationException("mappedField isn't an EphemeralMappedField");
            }
          } else {
            values.add(
                converters.decode((subtypeDest != null) ? subtypeDest : o.getClass(), o, mf));
          }
        } else {
          values.add(converters.decode((subtypeDest != null) ? subtypeDest : o.getClass(), o, mf));
        }
      ...
      values.add(
          converters.decode(
              (subtypeDest != null) ? subtypeDest : fromDBObject.getClass(), fromDBObject, mf));
    }
    ...
    if (value.getClass().isArray()) {
      ...
      if (!(value instanceof Iterable)) {
        throw new ConverterException(
            format("Cannot cast %s to Iterable for MappedField: %s", value.getClass(), mf));
      }
