...
public interface Geometry {
  /**
   * Returns a list of coordinates for this Geometry type. For something like a Point, this will be
   * a pair of lat/long coordinates, but for more complex types this will be a list of other
