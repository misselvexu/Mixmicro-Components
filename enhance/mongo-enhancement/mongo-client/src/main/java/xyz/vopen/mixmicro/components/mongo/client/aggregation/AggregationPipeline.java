 ...
 *
 * <p>mongodb.driver.manual core/aggregation-pipeline/ Aggregation Pipeline
 */
public interface AggregationPipeline {
   ...
   * @return this
   * <p>mongodb.driver.manual reference/operator/aggregation/geoNear $geoNear
   */
   ...
   * @return this
   * <p>mongodb.driver.manual reference/operator/aggregation/group $group
   */
   ...
   * @return this
   * <p>mongodb.driver.manual reference/operator/aggregation/limit $limit
   */
   ...
   * collection. To each input document, the $lookup stage adds a new array field whose elements are
   * the matching documents from the “joined” collection. The $lookup stage passes these reshaped
   ...
   * @return this
   * <p>mongodb.driver.manual reference/operator/aggregation/lookup $lookup
   * @since 1.2
   */
   ...
   * @return this
   * <p>mongodb.driver.manual reference/operator/aggregation/match $match
   */
   ...
   * @return this
   * <p>mongodb.driver.manual reference/operator/aggregation/match $sample
   */
   ...
   * @param <U> type of the results
   * @return an iterator of the computed results
   * <p>mongodb.driver.manual reference/operator/aggregation/out $out
   */
   ...
   * @return this
   * <p>mongodb.driver.manual reference/operator/aggregation/project $project
   */
   ...
   * @return this
   * <p>mongodb.driver.manual reference/operator/aggregation/skip $skip
   */
   ...
   * @return this
   * <p>mongodb.driver.manual reference/operator/aggregation/sort $sort
   */
   ...
   * @return this
   * <p>mongodb.driver.manual reference/operator/aggregation/unwind $unwind
   */
   ...
   * @return this
   * <p>mongodb.driver.manual reference/operator/aggregation/sortByCount $sortByCount
   * @since 1.5
   */
   ...
   * count field that contains the number of documents in the bucket. The count field is included by
   * default when the output is not specified.
   *
   ...
   *     boundaries.
   * @return this
   * <p>mongodb.driver.manual reference/operator/aggregation/bucket $bucket
   * @since 1.5
   */
   ...
   *
   * <p>Each bucket is represented as a document in the output. The document for each bucket
   * contains an _id field, whose value specifies the inclusive lower bound and the exclusive upper
   * bound for the bucket, and a count field that contains the number of documents in the bucket.
   ...
   * @return this
   * <p>mongodb.driver.manual reference/operator/aggregation/bucketAuto $bucketAuto
   * @since 1.5
   */
