...
public final class Projection {
   ...
   * @param args the projection arguments
   * @return the projection
   * <p>mongodb.driver.manual reference/operator/aggregation/add $add
   */
   ...
   * @return the projection
   * <p>mongodb.driver.manual reference/operator/aggregation/subtract $subtract
   */
   ...
   * @param args the projection arguments
   * @return the projection
   * <p>mongodb.driver.manual reference/operator/aggregation/multiply $multiply
   */
   ...
   * @param arg2 subtraction argument
   * @return the projection
   * <p>mongodb.driver.manual reference/operator/aggregation/divide $divide
   */
   ...
   *     array.
   * @return the projection
   * <p>mongodb.driver.manual reference/operator/aggregation/size $size
   */
   ...
   * @param arg2 subtraction argument
   * @return the projection
   * <p>mongodb.driver.manual reference/operator/aggregation/mod $mod
   */
