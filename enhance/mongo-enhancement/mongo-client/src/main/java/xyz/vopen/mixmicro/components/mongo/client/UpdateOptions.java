 ...
 *
 * <p>mongodb.driver.manual tutorial/modify-documents/ Updates
 * <p>mongodb.driver.manual reference/operator/update/ Update Operators
 * <p>mongodb.driver.manual reference/command/update/ Update Command
 * @since 1.3
 */
public class UpdateOptions {
   ...
   *
   * @param isUpsert true if a new document should be inserted if there are no matches to the query
   *     filter
   * @return this
   */
