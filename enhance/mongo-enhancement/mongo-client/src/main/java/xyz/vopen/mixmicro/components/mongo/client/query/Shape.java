...
public class Shape {
  ...
  /**
   * Specifies a rectangle for a geospatial $geoWithin query to return documents that are within the
   * bounds of the rectangle, according to their point-based location data.
   *
   * @param bottomLeft the bottom left bound
   * @param upperRight the upper right bound
   * @return the box
   * <p>mongodb.driver.manual reference/operator/query/box/ $box
   ...
   * @return the box
   * <p>mongodb.driver.manual reference/operator/query/center/ $center
   * <p>mongodb.driver.manual reference/operator/query/geoWithin/ $geoWithin
   */
   ...
   * @param radius the radius circle
   * @return the box
   * <p>mongodb.driver.manual reference/operator/query/centerSphere/ $centerSphere
   */
   ...
   * @return the box
   * <p>mongodb.driver.manual reference/operator/query/polygon/ $polygon
   * <p>mongodb.driver.manual reference/operator/query/geoWithin/ $geoWithin
   */
