...
import static xyz.vopen.mixmicro.components.mongo.client.geo.GeoJsonType.LINE_STRING;
import static xyz.vopen.mixmicro.components.mongo.client.geo.GeoJsonType.MULTI_LINE_STRING;
import static xyz.vopen.mixmicro.components.mongo.client.geo.GeoJsonType.MULTI_POINT;
import static xyz.vopen.mixmicro.components.mongo.client.geo.GeoJsonType.MULTI_POLYGON;
import static xyz.vopen.mixmicro.components.mongo.client.geo.GeoJsonType.POINT;
import static xyz.vopen.mixmicro.components.mongo.client.geo.GeoJsonType.POLYGON;
...
public class GeometryShapeConverter extends TypeConverter implements SimpleValueConverter {
  ...
  /**
   * Defines a new PolygonConverter. This extends and therefore configures GeometryShapeConverter to
   * provide the specific configuration for converting Polygon objects to and from <a
  ...
  /**
   * Defines a new MultiPointConverter. This extends and therefore configures GeometryShapeConverter
   * to provide the specific configuration for converting MultiPoint objects to and from <a
   * href="http://geojson.org/geojson-spec.html#id5">MongoDB representations</a> of the GeoJson.
   */
  ...
  /**
   * Defines a new LineStringConverter. This extends and therefore configures GeometryShapeConverter
   * to provide the specific configuration for converting LineString objects to and from <a
