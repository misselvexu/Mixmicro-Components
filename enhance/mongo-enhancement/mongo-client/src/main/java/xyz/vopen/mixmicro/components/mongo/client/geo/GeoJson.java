...
public final class GeoJson {
   ...
   * @return a Point instance representing a single location point defined by the given latitude and
   *     longitude
   ...
   * #polygon(LineString, LineString...)} to create the Polygon. If you need to create Polygons with
   * interior rings (holes), use that method.
   *
  ...
  /**
   * Lets you create a Polygon representing a GeoJSON Polygon type. This method is especially useful
   * for defining polygons with inner rings.
   *
   * @param exteriorBoundary a LineString that contains a series of Points that make up the polygon.
